...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [15:0] reqLowOperands_0 = io_req_bits_a[15:0]; // @[AecFpUnit.scala 210:43]
  wire [15:0] reqLowOperands_1 = io_req_bits_b[15:0]; // @[AecFpUnit.scala 210:67]
  wire  reqDtypeSupported = io_req_bits_dtype == 4'h9; // @[AecFpUnit.scala 222:75]
  reg [63:0] integratedSimpleResp_result; // @[AecFpUnit.scala 236:58]
  reg  integratedSimpleResp_predicate_result; // @[AecFpUnit.scala 236:58]
  reg  integratedSimpleResp_error; // @[AecFpUnit.scala 236:58]
  reg  busy; // @[AecFpUnit.scala 239:23]
  reg  pipePending; // @[AecFpUnit.scala 240:30]
  wire  _f64Pipe_io_req_valid_T_2 = ~busy; // @[AecFpUnit.scala 243:77]
  wire  _io_req_ready_T_2 = reqPipe ? f64Pipe_io_req_ready : 1'h1; // @[AecFpUnit.scala 244:54]
  wire  f64AtHead = busy & pipePending & f64Pipe_io_resp_valid; // @[AecFpUnit.scala 245:38]
  wire  oldAtHead = busy & ~pipePending; // @[AecFpUnit.scala 246:23]
  wire  _integratedSimpleCapture_T = io_req_ready & io_req_valid; // @[Decoupled.scala 51:35]
  wire  integratedSimpleCapture = _integratedSimpleCapture_T & ~reqPipe; // @[AecFpUnit.scala 247:44]
  wire  _GEN_0 = _integratedSimpleCapture_T | busy; // @[AecFpUnit.scala 248:24 249:12 239:23]
  wire  _T_4 = io_resp_ready & io_resp_valid; // @[Decoupled.scala 51:35]
  wire  isF32 = io_req_bits_dtype == 4'h8; // @[AecFpUnit.scala 276:26]
  wire [31:0] _cmp16_io_a_T_3 = {reqLowOperands_0,16'h0}; // @[Cat.scala 33:92]
  wire [31:0] _cmp16_io_a_T_7 = 4'ha == io_req_bits_dtype ? {{16'd0}, reqLowOperands_0} : io_req_bits_a[31:0]; // @[Mux.scala 81:58]
  wire [31:0] _cmp16_io_a_T_9 = 4'hb == io_req_bits_dtype ? _cmp16_io_a_T_3 : _cmp16_io_a_T_7; // @[Mux.scala 81:58]
  wire [31:0] _cmp16_io_a_T_11 = 4'h8 == io_req_bits_dtype ? io_req_bits_a[31:0] : _cmp16_io_a_T_9; // @[Mux.scala 81:58]
  wire [63:0] _cmp16_io_a_T_13 = 4'h9 == io_req_bits_dtype ? io_req_bits_a : {{32'd0}, _cmp16_io_a_T_11}; // @[Mux.scala 81:58]
  ...
  wire [24:0] _GEN_4 = {{15'd0}, cmp16_io_a_rawIn_fractIn}; // @[rawFloatFromFN.scala 52:33]
  wire [24:0] _cmp16_io_a_rawIn_subnormFract_T = _GEN_4 << cmp16_io_a_rawIn_normDist; // @[rawFloatFromFN.scala 52:33]
  wire [9:0] cmp16_io_a_rawIn_subnormFract = {_cmp16_io_a_rawIn_subnormFract_T[8:0], 1'h0}; // @[rawFloatFromFN.scala 52:64]
  wire [5:0] _GEN_8 = {{2'd0}, cmp16_io_a_rawIn_normDist}; // @[rawFloatFromFN.scala 55:18]
  wire [5:0] _cmp16_io_a_rawIn_adjustedExp_T = _GEN_8 ^ 6'h3f; // @[rawFloatFromFN.scala 55:18]
  ...
  wire [4:0] _GEN_9 = {{3'd0}, _cmp16_io_a_rawIn_adjustedExp_T_2}; // @[rawFloatFromFN.scala 58:9]
  wire [4:0] _cmp16_io_a_rawIn_adjustedExp_T_3 = 5'h10 | _GEN_9; // @[rawFloatFromFN.scala 58:9]
  wire [5:0] _GEN_10 = {{1'd0}, _cmp16_io_a_rawIn_adjustedExp_T_3}; // @[rawFloatFromFN.scala 57:9]
  wire [5:0] cmp16_io_a_rawIn_adjustedExp = _cmp16_io_a_rawIn_adjustedExp_T_1 + _GEN_10; // @[rawFloatFromFN.scala 57:9]
  ...
  wire [2:0] _GEN_11 = {{2'd0}, cmp16_io_a_rawIn__isNaN}; // @[recFNFromFN.scala 48:76]
  wire [2:0] _cmp16_io_a_T_17 = _cmp16_io_a_T_15 | _GEN_11; // @[recFNFromFN.scala 48:76]
  wire [6:0] _cmp16_io_a_T_20 = {cmp16_io_a_rawIn_sign,_cmp16_io_a_T_17,cmp16_io_a_rawIn__sExp[2:0]}; // @[recFNFromFN.scala 49:45]
  wire [31:0] _cmp16_io_b_T_3 = {reqLowOperands_1,16'h0}; // @[Cat.scala 33:92]
  wire [31:0] _cmp16_io_b_T_7 = 4'ha == io_req_bits_dtype ? {{16'd0}, reqLowOperands_1} : io_req_bits_b[31:0]; // @[Mux.scala 81:58]
  wire [31:0] _cmp16_io_b_T_9 = 4'hb == io_req_bits_dtype ? _cmp16_io_b_T_3 : _cmp16_io_b_T_7; // @[Mux.scala 81:58]
  wire [31:0] _cmp16_io_b_T_11 = 4'h8 == io_req_bits_dtype ? io_req_bits_b[31:0] : _cmp16_io_b_T_9; // @[Mux.scala 81:58]
  wire [63:0] _cmp16_io_b_T_13 = 4'h9 == io_req_bits_dtype ? io_req_bits_b : {{32'd0}, _cmp16_io_b_T_11}; // @[Mux.scala 81:58]
  ...
  wire [24:0] _GEN_5 = {{15'd0}, cmp16_io_b_rawIn_fractIn}; // @[rawFloatFromFN.scala 52:33]
  wire [24:0] _cmp16_io_b_rawIn_subnormFract_T = _GEN_5 << cmp16_io_b_rawIn_normDist; // @[rawFloatFromFN.scala 52:33]
  wire [9:0] cmp16_io_b_rawIn_subnormFract = {_cmp16_io_b_rawIn_subnormFract_T[8:0], 1'h0}; // @[rawFloatFromFN.scala 52:64]
  wire [5:0] _GEN_12 = {{2'd0}, cmp16_io_b_rawIn_normDist}; // @[rawFloatFromFN.scala 55:18]
  wire [5:0] _cmp16_io_b_rawIn_adjustedExp_T = _GEN_12 ^ 6'h3f; // @[rawFloatFromFN.scala 55:18]
  ...
  wire [4:0] _GEN_13 = {{3'd0}, _cmp16_io_b_rawIn_adjustedExp_T_2}; // @[rawFloatFromFN.scala 58:9]
  wire [4:0] _cmp16_io_b_rawIn_adjustedExp_T_3 = 5'h10 | _GEN_13; // @[rawFloatFromFN.scala 58:9]
  wire [5:0] _GEN_14 = {{1'd0}, _cmp16_io_b_rawIn_adjustedExp_T_3}; // @[rawFloatFromFN.scala 57:9]
  wire [5:0] cmp16_io_b_rawIn_adjustedExp = _cmp16_io_b_rawIn_adjustedExp_T_1 + _GEN_14; // @[rawFloatFromFN.scala 57:9]
  ...
  wire [2:0] _GEN_15 = {{2'd0}, cmp16_io_b_rawIn__isNaN}; // @[recFNFromFN.scala 48:76]
  wire [2:0] _cmp16_io_b_T_17 = _cmp16_io_b_T_15 | _GEN_15; // @[recFNFromFN.scala 48:76]
  ...
  wire [53:0] _GEN_6 = {{31'd0}, cmp32_io_a_rawIn_fractIn}; // @[rawFloatFromFN.scala 52:33]
  wire [53:0] _cmp32_io_a_rawIn_subnormFract_T = _GEN_6 << cmp32_io_a_rawIn_normDist; // @[rawFloatFromFN.scala 52:33]
  ...
  wire [2:0] _cmp32_io_a_T_17 = _cmp32_io_a_T_15 | _GEN_19; // @[recFNFromFN.scala 48:76]
  ...
  wire [53:0] _GEN_7 = {{31'd0}, cmp32_io_b_rawIn_fractIn}; // @[rawFloatFromFN.scala 52:33]
  wire [53:0] _cmp32_io_b_rawIn_subnormFract_T = _GEN_7 << cmp32_io_b_rawIn_normDist; // @[rawFloatFromFN.scala 52:33]
  ...
  wire [2:0] _cmp32_io_b_T_17 = _cmp32_io_b_T_15 | _GEN_23; // @[recFNFromFN.scala 48:76]
  wire [9:0] _cmp32_io_b_T_20 = {cmp32_io_b_rawIn_sign,_cmp32_io_b_T_17,cmp32_io_b_rawIn__sExp[5:0]}; // @[recFNFromFN.scala 49:45]
  wire  cmp64_io_a_rawIn_sign = io_req_bits_a[63]; // @[rawFloatFromFN.scala 44:18]
  wire [10:0] cmp64_io_a_rawIn_expIn = io_req_bits_a[62:52]; // @[rawFloatFromFN.scala 45:19]
  wire [51:0] cmp64_io_a_rawIn_fractIn = io_req_bits_a[51:0]; // @[rawFloatFromFN.scala 46:21]
  ...
  wire [114:0] _GEN_33 = {{63'd0}, cmp64_io_a_rawIn_fractIn}; // @[rawFloatFromFN.scala 52:33]
  wire [114:0] _cmp64_io_a_rawIn_subnormFract_T = _GEN_33 << cmp64_io_a_rawIn_normDist; // @[rawFloatFromFN.scala 52:33]
  wire [51:0] cmp64_io_a_rawIn_subnormFract = {_cmp64_io_a_rawIn_subnormFract_T[50:0], 1'h0}; // @[rawFloatFromFN.scala 52:64]
  wire [11:0] _GEN_24 = {{6'd0}, cmp64_io_a_rawIn_normDist}; // @[rawFloatFromFN.scala 55:18]
  wire [11:0] _cmp64_io_a_rawIn_adjustedExp_T = _GEN_24 ^ 12'hfff; // @[rawFloatFromFN.scala 55:18]
  ...
  wire [10:0] _GEN_25 = {{9'd0}, _cmp64_io_a_rawIn_adjustedExp_T_2}; // @[rawFloatFromFN.scala 58:9]
  wire [10:0] _cmp64_io_a_rawIn_adjustedExp_T_3 = 11'h400 | _GEN_25; // @[rawFloatFromFN.scala 58:9]
  wire [11:0] _GEN_26 = {{1'd0}, _cmp64_io_a_rawIn_adjustedExp_T_3}; // @[rawFloatFromFN.scala 57:9]
  wire [11:0] cmp64_io_a_rawIn_adjustedExp = _cmp64_io_a_rawIn_adjustedExp_T_1 + _GEN_26; // @[rawFloatFromFN.scala 57:9]
  ...
  wire [2:0] _GEN_27 = {{2'd0}, cmp64_io_a_rawIn__isNaN}; // @[recFNFromFN.scala 48:76]
  wire [2:0] _cmp64_io_a_T_3 = _cmp64_io_a_T_1 | _GEN_27; // @[recFNFromFN.scala 48:76]
  wire [12:0] _cmp64_io_a_T_6 = {cmp64_io_a_rawIn_sign,_cmp64_io_a_T_3,cmp64_io_a_rawIn__sExp[8:0]}; // @[recFNFromFN.scala 49:45]
  wire  cmp64_io_b_rawIn_sign = io_req_bits_b[63]; // @[rawFloatFromFN.scala 44:18]
  wire [10:0] cmp64_io_b_rawIn_expIn = io_req_bits_b[62:52]; // @[rawFloatFromFN.scala 45:19]
  wire [51:0] cmp64_io_b_rawIn_fractIn = io_req_bits_b[51:0]; // @[rawFloatFromFN.scala 46:21]
  ...
  wire [114:0] _GEN_34 = {{63'd0}, cmp64_io_b_rawIn_fractIn}; // @[rawFloatFromFN.scala 52:33]
  wire [114:0] _cmp64_io_b_rawIn_subnormFract_T = _GEN_34 << cmp64_io_b_rawIn_normDist; // @[rawFloatFromFN.scala 52:33]
  wire [51:0] cmp64_io_b_rawIn_subnormFract = {_cmp64_io_b_rawIn_subnormFract_T[50:0], 1'h0}; // @[rawFloatFromFN.scala 52:64]
  wire [11:0] _GEN_28 = {{6'd0}, cmp64_io_b_rawIn_normDist}; // @[rawFloatFromFN.scala 55:18]
  wire [11:0] _cmp64_io_b_rawIn_adjustedExp_T = _GEN_28 ^ 12'hfff; // @[rawFloatFromFN.scala 55:18]
  ...
  wire [10:0] _GEN_29 = {{9'd0}, _cmp64_io_b_rawIn_adjustedExp_T_2}; // @[rawFloatFromFN.scala 58:9]
  wire [10:0] _cmp64_io_b_rawIn_adjustedExp_T_3 = 11'h400 | _GEN_29; // @[rawFloatFromFN.scala 58:9]
  wire [11:0] _GEN_30 = {{1'd0}, _cmp64_io_b_rawIn_adjustedExp_T_3}; // @[rawFloatFromFN.scala 57:9]
  wire [11:0] cmp64_io_b_rawIn_adjustedExp = _cmp64_io_b_rawIn_adjustedExp_T_1 + _GEN_30; // @[rawFloatFromFN.scala 57:9]
  ...
  wire [2:0] _GEN_31 = {{2'd0}, cmp64_io_b_rawIn__isNaN}; // @[recFNFromFN.scala 48:76]
  wire [2:0] _cmp64_io_b_T_3 = _cmp64_io_b_T_1 | _GEN_31; // @[recFNFromFN.scala 48:76]
  wire [12:0] _cmp64_io_b_T_6 = {cmp64_io_b_rawIn_sign,_cmp64_io_b_T_3,cmp64_io_b_rawIn__sExp[8:0]}; // @[recFNFromFN.scala 49:45]
  wire  isCmp = io_req_bits_op >= 7'h20 & io_req_bits_op < 7'h26; // @[AecFpUnit.scala 292:42]
  wire  isCmpP = io_req_bits_op >= 7'h28 & io_req_bits_op < 7'h2e; // @[AecFpUnit.scala 293:44]
  wire [6:0] _cmpMode_T_1 = io_req_bits_op - 7'h28; // @[AecFpUnit.scala 294:37]
  wire [6:0] _cmpMode_T_3 = io_req_bits_op - 7'h20; // @[AecFpUnit.scala 294:65]
  wire [6:0] cmpMode = isCmpP ? _cmpMode_T_1 : _cmpMode_T_3; // @[AecFpUnit.scala 294:20]
  wire  _cmpTrue_T_1 = 4'ha == io_req_bits_dtype ? cmp16_io_eq : cmp32_io_eq; // @[Mux.scala 81:58]
  wire  _cmpTrue_T_3 = 4'hb == io_req_bits_dtype ? cmp32_io_eq : _cmpTrue_T_1; // @[Mux.scala 81:58]
  wire  _cmpTrue_T_5 = 4'h9 == io_req_bits_dtype ? cmp64_io_eq : _cmpTrue_T_3; // @[Mux.scala 81:58]
  ...
  wire  _cmpTrue_T_11 = 4'ha == io_req_bits_dtype ? _cmpTrue_T_7 : _cmpTrue_T_6; // @[Mux.scala 81:58]
  wire  _cmpTrue_T_13 = 4'hb == io_req_bits_dtype ? _cmpTrue_T_6 : _cmpTrue_T_11; // @[Mux.scala 81:58]
  wire  _cmpTrue_T_15 = 4'h9 == io_req_bits_dtype ? _cmpTrue_T_9 : _cmpTrue_T_13; // @[Mux.scala 81:58]
  wire  _cmpTrue_T_17 = 4'ha == io_req_bits_dtype ? cmp16_io_lt : cmp32_io_lt; // @[Mux.scala 81:58]
  wire  _cmpTrue_T_19 = 4'hb == io_req_bits_dtype ? cmp32_io_lt : _cmpTrue_T_17; // @[Mux.scala 81:58]
  wire  _cmpTrue_T_21 = 4'h9 == io_req_bits_dtype ? cmp64_io_lt : _cmpTrue_T_19; // @[Mux.scala 81:58]
  ...
  wire  _cmpTrue_T_27 = 4'ha == io_req_bits_dtype ? _cmpTrue_T_23 : _cmpTrue_T_22; // @[Mux.scala 81:58]
  wire  _cmpTrue_T_29 = 4'hb == io_req_bits_dtype ? _cmpTrue_T_22 : _cmpTrue_T_27; // @[Mux.scala 81:58]
  wire  _cmpTrue_T_31 = 4'h9 == io_req_bits_dtype ? _cmpTrue_T_25 : _cmpTrue_T_29; // @[Mux.scala 81:58]
  wire  _cmpTrue_T_33 = 4'ha == io_req_bits_dtype ? cmp16_io_gt : cmp32_io_gt; // @[Mux.scala 81:58]
  wire  _cmpTrue_T_35 = 4'hb == io_req_bits_dtype ? cmp32_io_gt : _cmpTrue_T_33; // @[Mux.scala 81:58]
  wire  _cmpTrue_T_37 = 4'h9 == io_req_bits_dtype ? cmp64_io_gt : _cmpTrue_T_35; // @[Mux.scala 81:58]
  ...
  wire  _cmpTrue_T_43 = 4'ha == io_req_bits_dtype ? _cmpTrue_T_39 : _cmpTrue_T_38; // @[Mux.scala 81:58]
  wire  _cmpTrue_T_45 = 4'hb == io_req_bits_dtype ? _cmpTrue_T_38 : _cmpTrue_T_43; // @[Mux.scala 81:58]
  wire  _cmpTrue_T_47 = 4'h9 == io_req_bits_dtype ? _cmpTrue_T_41 : _cmpTrue_T_45; // @[Mux.scala 81:58]
  ...
  wire  aNaN32 = &io_req_bits_a[30:23] & |io_req_bits_a[22:0]; // @[AecFpUnit.scala 303:33]
  wire  bNaN32 = &io_req_bits_b[30:23] & |io_req_bits_b[22:0]; // @[AecFpUnit.scala 304:33]
  wire  bothZero32 = io_req_bits_a[30:0] == 31'h0 & io_req_bits_b[30:0] == 31'h0; // @[AecFpUnit.scala 305:39]
  wire  _minNumeric32_T_2 = io_req_bits_a[31] | io_req_bits_b[31]; // @[AecFpUnit.scala 306:50]
  wire [31:0] _minNumeric32_T_3 = {_minNumeric32_T_2,31'h0}; // @[Cat.scala 33:92]
  wire [31:0] _minNumeric32_T_4 = cmp32_io_lt ? io_req_bits_a[31:0] : io_req_bits_b[31:0]; // @[AecFpUnit.scala 306:76]
  wire [31:0] minNumeric32 = bothZero32 ? _minNumeric32_T_3 : _minNumeric32_T_4; // @[AecFpUnit.scala 306:25]
  wire  _maxNumeric32_T_2 = io_req_bits_a[31] & io_req_bits_b[31]; // @[AecFpUnit.scala 307:50]
  wire [31:0] _maxNumeric32_T_3 = {_maxNumeric32_T_2,31'h0}; // @[Cat.scala 33:92]
  wire [31:0] _maxNumeric32_T_4 = cmp32_io_gt ? io_req_bits_a[31:0] : io_req_bits_b[31:0]; // @[AecFpUnit.scala 307:76]
  wire [31:0] maxNumeric32 = bothZero32 ? _maxNumeric32_T_3 : _maxNumeric32_T_4; // @[AecFpUnit.scala 307:25]
  wire  _minMax32_T_1 = io_req_bits_op == 7'h9; // @[AecFpUnit.scala 309:51]
  wire [31:0] _minMax32_T_2 = io_req_bits_op == 7'h9 ? minNumeric32 : maxNumeric32; // @[AecFpUnit.scala 309:42]
  wire [31:0] _minMax32_T_3 = bNaN32 ? io_req_bits_a[31:0] : _minMax32_T_2; // @[AecFpUnit.scala 309:25]
  wire [31:0] _minMax32_T_4 = aNaN32 ? io_req_bits_b[31:0] : _minMax32_T_3; // @[AecFpUnit.scala 309:8]
  ...
  wire [126:0] unarySign = reqDtypeSupported ? 127'h8000000000000000 : {{32'd0}, _unarySign_T_3}; // @[AecFpUnit.scala 310:22]
  wire  _unaryRaw_T = io_req_bits_op == 7'h8; // @[AecFpUnit.scala 311:30]
  wire [126:0] _unaryRaw_T_1 = ~unarySign; // @[AecFpUnit.scala 311:56]
  wire [126:0] _GEN_32 = {{63'd0}, io_req_bits_a}; // @[AecFpUnit.scala 311:54]
  wire [126:0] _unaryRaw_T_2 = _GEN_32 & _unaryRaw_T_1; // @[AecFpUnit.scala 311:54]
  wire  _unaryRaw_T_3 = io_req_bits_op == 7'h7; // @[AecFpUnit.scala 311:80]
  wire [126:0] _unaryRaw_T_4 = _GEN_32 ^ unarySign; // @[AecFpUnit.scala 311:104]
  wire [126:0] _unaryRaw_T_5 = io_req_bits_op == 7'h7 ? _unaryRaw_T_4 : {{63'd0}, io_req_bits_a}; // @[AecFpUnit.scala 311:71]
  wire [126:0] unaryRaw = io_req_bits_op == 7'h8 ? _unaryRaw_T_2 : _unaryRaw_T_5; // @[AecFpUnit.scala 311:21]
  ...
  wire [126:0] unary = reqDtypeSupported ? unaryRaw : {{63'd0}, _unary_T_4}; // @[AecFpUnit.scala 312:18]
  wire  isMinMax = _minMax32_T_1 | io_req_bits_op == 7'ha; // @[AecFpUnit.scala 313:42]
  ...
  wire [126:0] _GEN_3 = integratedSimpleCapture ? oldResult : {{63'd0}, integratedSimpleResp_result}; // @[AecFpUnit.scala 334:36 335:39 236:58]
  ...
  assign io_req_ready = reqDtypeSupported & _f64Pipe_io_req_valid_T_2 & _io_req_ready_T_2; // @[AecFpUnit.scala 244:48]
  assign io_resp_valid = f64AtHead | oldAtHead; // @[AecFpUnit.scala 290:34]
  assign io_resp_bits_result = f64AtHead ? pipeResult : integratedSimpleResp_result; // @[AecFpUnit.scala 341:31]
  assign io_resp_bits_predicate_result = f64AtHead ? 1'h0 : integratedSimpleResp_predicate_result; // @[AecFpUnit.scala 342:41]
  assign io_resp_bits_error = f64AtHead ? 1'h0 : integratedSimpleResp_error; // @[AecFpUnit.scala 344:30]
  assign io_resp_bits_exception_flags = f64AtHead ? f64Pipe_io_resp_bits_fflags : 5'h0; // @[AecFpUnit.scala 345:40]
  assign f64Pipe_clock = clock;
  assign f64Pipe_reset = reset;
  assign f64Pipe_io_req_valid = io_req_valid & reqPipe & reqDtypeSupported & ~busy; // @[AecFpUnit.scala 243:74]
  ...
  always @(posedge clock) begin
    integratedSimpleResp_result <= _GEN_3[63:0];
    if (integratedSimpleCapture) begin // @[AecFpUnit.scala 334:36]
      integratedSimpleResp_predicate_result <= oldPredicate; // @[AecFpUnit.scala 336:49]
    end
    if (integratedSimpleCapture) begin // @[AecFpUnit.scala 334:36]
      integratedSimpleResp_error <= oldError; // @[AecFpUnit.scala 338:38]
    end
    if (reset) begin // @[AecFpUnit.scala 239:23]
      busy <= 1'h0; // @[AecFpUnit.scala 239:23]
    end else if (_T_4) begin // @[AecFpUnit.scala 252:25]
      busy <= 1'h0; // @[AecFpUnit.scala 252:32]
    end else begin
      busy <= _GEN_0;
    end
    if (reset) begin // @[AecFpUnit.scala 240:30]
      pipePending <= 1'h0; // @[AecFpUnit.scala 240:30]
    end else if (_integratedSimpleCapture_T) begin // @[AecFpUnit.scala 248:24]
      pipePending <= reqPipe; // @[AecFpUnit.scala 250:19]
    end
  end
// Register and memory initialization
`ifdef RANDOMIZE_GARBAGE_ASSIGN
...
`endif // RANDOMIZE_REG_INIT
  ...
  reg [1:0] selectedGroup; // @[AecFpUnit.scala 67:28]
  wire  dataReady = ~dataValid | io_out_ready; // @[AecFpUnit.scala 68:32]
  wire  selectReady = ~selectValid | dataReady; // @[AecFpUnit.scala 69:36]
  wire [6:0] _GEN_1 = 2'h1 == selectedGroup ? io_data_1_op : io_data_0_op; // @[AecFpUnit.scala 76:{33,33}]
  wire [3:0] _GEN_5 = 2'h1 == selectedGroup ? io_data_1_dtype : io_data_0_dtype; // @[AecFpUnit.scala 76:{33,33}]
  wire [63:0] _GEN_9 = 2'h1 == selectedGroup ? io_data_1_a : io_data_0_a; // @[AecFpUnit.scala 76:{33,33}]
  wire [63:0] _GEN_13 = 2'h1 == selectedGroup ? io_data_1_b : io_data_0_b; // @[AecFpUnit.scala 76:{33,33}]
  wire [63:0] _GEN_17 = 2'h1 == selectedGroup ? io_data_1_c : io_data_0_c; // @[AecFpUnit.scala 76:{33,33}]
  ...
  always @(posedge clock) begin
    ...
    if (dataReady) begin // @[AecFpUnit.scala 74:22]
      if (selectValid) begin // @[AecFpUnit.scala 76:26]
        if (2'h3 == selectedGroup) begin // @[AecFpUnit.scala 76:33]
          data_op <= io_data_3_op; // @[AecFpUnit.scala 76:33]
        end else if (2'h2 == selectedGroup) begin // @[AecFpUnit.scala 76:33]
          data_op <= io_data_2_op; // @[AecFpUnit.scala 76:33]
        end else begin
          data_op <= _GEN_1;
        end
      end
    ...
    if (dataReady) begin // @[AecFpUnit.scala 74:22]
      if (selectValid) begin // @[AecFpUnit.scala 76:26]
        if (2'h3 == selectedGroup) begin // @[AecFpUnit.scala 76:33]
          data_dtype <= io_data_3_dtype; // @[AecFpUnit.scala 76:33]
        end else if (2'h2 == selectedGroup) begin // @[AecFpUnit.scala 76:33]
          data_dtype <= io_data_2_dtype; // @[AecFpUnit.scala 76:33]
        end else begin
          data_dtype <= _GEN_5;
        end
      end
    ...
    if (dataReady) begin // @[AecFpUnit.scala 74:22]
      if (selectValid) begin // @[AecFpUnit.scala 76:26]
        if (2'h3 == selectedGroup) begin // @[AecFpUnit.scala 76:33]
          data_a <= io_data_3_a; // @[AecFpUnit.scala 76:33]
        end else if (2'h2 == selectedGroup) begin // @[AecFpUnit.scala 76:33]
          data_a <= io_data_2_a; // @[AecFpUnit.scala 76:33]
        end else begin
          data_a <= _GEN_9;
        end
      end
    ...
    if (dataReady) begin // @[AecFpUnit.scala 74:22]
      if (selectValid) begin // @[AecFpUnit.scala 76:26]
        if (2'h3 == selectedGroup) begin // @[AecFpUnit.scala 76:33]
          data_b <= io_data_3_b; // @[AecFpUnit.scala 76:33]
        end else if (2'h2 == selectedGroup) begin // @[AecFpUnit.scala 76:33]
          data_b <= io_data_2_b; // @[AecFpUnit.scala 76:33]
        end else begin
          data_b <= _GEN_13;
        end
      end
    ...
    if (dataReady) begin // @[AecFpUnit.scala 74:22]
      if (selectValid) begin // @[AecFpUnit.scala 76:26]
        if (2'h3 == selectedGroup) begin // @[AecFpUnit.scala 76:33]
          data_c <= io_data_3_c; // @[AecFpUnit.scala 76:33]
        end else if (2'h2 == selectedGroup) begin // @[AecFpUnit.scala 76:33]
          data_c <= io_data_2_c; // @[AecFpUnit.scala 76:33]
        end else begin
          data_c <= _GEN_17;
        end
      end
...
`ifdef RANDOMIZE_REG_INIT
  ...
  reg [31:0] _RAND_14;
`endif // RANDOMIZE_REG_INIT
  wire  pipes_0_clock; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_0_reset; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_0_io_req_ready; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_0_io_req_valid; // @[AecFpWarpUnits.scala 112:45]
  wire [6:0] pipes_0_io_req_bits_op; // @[AecFpWarpUnits.scala 112:45]
  wire [3:0] pipes_0_io_req_bits_dtype; // @[AecFpWarpUnits.scala 112:45]
  wire [63:0] pipes_0_io_req_bits_a; // @[AecFpWarpUnits.scala 112:45]
  wire [63:0] pipes_0_io_req_bits_b; // @[AecFpWarpUnits.scala 112:45]
  wire [63:0] pipes_0_io_req_bits_c; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_0_io_resp_ready; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_0_io_resp_valid; // @[AecFpWarpUnits.scala 112:45]
  wire [63:0] pipes_0_io_resp_bits_result; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_0_io_resp_bits_predicate_result; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_0_io_resp_bits_error; // @[AecFpWarpUnits.scala 112:45]
  wire [4:0] pipes_0_io_resp_bits_exception_flags; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_1_clock; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_1_reset; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_1_io_req_ready; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_1_io_req_valid; // @[AecFpWarpUnits.scala 112:45]
  wire [6:0] pipes_1_io_req_bits_op; // @[AecFpWarpUnits.scala 112:45]
  wire [3:0] pipes_1_io_req_bits_dtype; // @[AecFpWarpUnits.scala 112:45]
  wire [63:0] pipes_1_io_req_bits_a; // @[AecFpWarpUnits.scala 112:45]
  wire [63:0] pipes_1_io_req_bits_b; // @[AecFpWarpUnits.scala 112:45]
  wire [63:0] pipes_1_io_req_bits_c; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_1_io_resp_ready; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_1_io_resp_valid; // @[AecFpWarpUnits.scala 112:45]
  wire [63:0] pipes_1_io_resp_bits_result; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_1_io_resp_bits_predicate_result; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_1_io_resp_bits_error; // @[AecFpWarpUnits.scala 112:45]
  wire [4:0] pipes_1_io_resp_bits_exception_flags; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_2_clock; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_2_reset; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_2_io_req_ready; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_2_io_req_valid; // @[AecFpWarpUnits.scala 112:45]
  wire [6:0] pipes_2_io_req_bits_op; // @[AecFpWarpUnits.scala 112:45]
  wire [3:0] pipes_2_io_req_bits_dtype; // @[AecFpWarpUnits.scala 112:45]
  wire [63:0] pipes_2_io_req_bits_a; // @[AecFpWarpUnits.scala 112:45]
  wire [63:0] pipes_2_io_req_bits_b; // @[AecFpWarpUnits.scala 112:45]
  wire [63:0] pipes_2_io_req_bits_c; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_2_io_resp_ready; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_2_io_resp_valid; // @[AecFpWarpUnits.scala 112:45]
  wire [63:0] pipes_2_io_resp_bits_result; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_2_io_resp_bits_predicate_result; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_2_io_resp_bits_error; // @[AecFpWarpUnits.scala 112:45]
  wire [4:0] pipes_2_io_resp_bits_exception_flags; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_3_clock; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_3_reset; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_3_io_req_ready; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_3_io_req_valid; // @[AecFpWarpUnits.scala 112:45]
  wire [6:0] pipes_3_io_req_bits_op; // @[AecFpWarpUnits.scala 112:45]
  wire [3:0] pipes_3_io_req_bits_dtype; // @[AecFpWarpUnits.scala 112:45]
  wire [63:0] pipes_3_io_req_bits_a; // @[AecFpWarpUnits.scala 112:45]
  wire [63:0] pipes_3_io_req_bits_b; // @[AecFpWarpUnits.scala 112:45]
  wire [63:0] pipes_3_io_req_bits_c; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_3_io_resp_ready; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_3_io_resp_valid; // @[AecFpWarpUnits.scala 112:45]
  wire [63:0] pipes_3_io_resp_bits_result; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_3_io_resp_bits_predicate_result; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_3_io_resp_bits_error; // @[AecFpWarpUnits.scala 112:45]
  wire [4:0] pipes_3_io_resp_bits_exception_flags; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_4_clock; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_4_reset; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_4_io_req_ready; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_4_io_req_valid; // @[AecFpWarpUnits.scala 112:45]
  wire [6:0] pipes_4_io_req_bits_op; // @[AecFpWarpUnits.scala 112:45]
  wire [3:0] pipes_4_io_req_bits_dtype; // @[AecFpWarpUnits.scala 112:45]
  wire [63:0] pipes_4_io_req_bits_a; // @[AecFpWarpUnits.scala 112:45]
  wire [63:0] pipes_4_io_req_bits_b; // @[AecFpWarpUnits.scala 112:45]
  wire [63:0] pipes_4_io_req_bits_c; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_4_io_resp_ready; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_4_io_resp_valid; // @[AecFpWarpUnits.scala 112:45]
  wire [63:0] pipes_4_io_resp_bits_result; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_4_io_resp_bits_predicate_result; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_4_io_resp_bits_error; // @[AecFpWarpUnits.scala 112:45]
  wire [4:0] pipes_4_io_resp_bits_exception_flags; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_5_clock; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_5_reset; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_5_io_req_ready; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_5_io_req_valid; // @[AecFpWarpUnits.scala 112:45]
  wire [6:0] pipes_5_io_req_bits_op; // @[AecFpWarpUnits.scala 112:45]
  wire [3:0] pipes_5_io_req_bits_dtype; // @[AecFpWarpUnits.scala 112:45]
  wire [63:0] pipes_5_io_req_bits_a; // @[AecFpWarpUnits.scala 112:45]
  wire [63:0] pipes_5_io_req_bits_b; // @[AecFpWarpUnits.scala 112:45]
  wire [63:0] pipes_5_io_req_bits_c; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_5_io_resp_ready; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_5_io_resp_valid; // @[AecFpWarpUnits.scala 112:45]
  wire [63:0] pipes_5_io_resp_bits_result; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_5_io_resp_bits_predicate_result; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_5_io_resp_bits_error; // @[AecFpWarpUnits.scala 112:45]
  wire [4:0] pipes_5_io_resp_bits_exception_flags; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_6_clock; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_6_reset; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_6_io_req_ready; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_6_io_req_valid; // @[AecFpWarpUnits.scala 112:45]
  wire [6:0] pipes_6_io_req_bits_op; // @[AecFpWarpUnits.scala 112:45]
  wire [3:0] pipes_6_io_req_bits_dtype; // @[AecFpWarpUnits.scala 112:45]
  wire [63:0] pipes_6_io_req_bits_a; // @[AecFpWarpUnits.scala 112:45]
  wire [63:0] pipes_6_io_req_bits_b; // @[AecFpWarpUnits.scala 112:45]
  wire [63:0] pipes_6_io_req_bits_c; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_6_io_resp_ready; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_6_io_resp_valid; // @[AecFpWarpUnits.scala 112:45]
  wire [63:0] pipes_6_io_resp_bits_result; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_6_io_resp_bits_predicate_result; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_6_io_resp_bits_error; // @[AecFpWarpUnits.scala 112:45]
  wire [4:0] pipes_6_io_resp_bits_exception_flags; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_7_clock; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_7_reset; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_7_io_req_ready; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_7_io_req_valid; // @[AecFpWarpUnits.scala 112:45]
  wire [6:0] pipes_7_io_req_bits_op; // @[AecFpWarpUnits.scala 112:45]
  wire [3:0] pipes_7_io_req_bits_dtype; // @[AecFpWarpUnits.scala 112:45]
  wire [63:0] pipes_7_io_req_bits_a; // @[AecFpWarpUnits.scala 112:45]
  wire [63:0] pipes_7_io_req_bits_b; // @[AecFpWarpUnits.scala 112:45]
  wire [63:0] pipes_7_io_req_bits_c; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_7_io_resp_ready; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_7_io_resp_valid; // @[AecFpWarpUnits.scala 112:45]
  wire [63:0] pipes_7_io_resp_bits_result; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_7_io_resp_bits_predicate_result; // @[AecFpWarpUnits.scala 112:45]
  wire  pipes_7_io_resp_bits_error; // @[AecFpWarpUnits.scala 112:45]
  wire [4:0] pipes_7_io_resp_bits_exception_flags; // @[AecFpWarpUnits.scala 112:45]
  wire  requestStages_0_clock; // @[AecFpWarpUnits.scala 114:53]
  wire  requestStages_0_reset; // @[AecFpWarpUnits.scala 114:53]
  wire  requestStages_0_io_inValid; // @[AecFpWarpUnits.scala 114:53]
  wire  requestStages_0_io_inReady; // @[AecFpWarpUnits.scala 114:53]
  wire [1:0] requestStages_0_io_group; // @[AecFpWarpUnits.scala 114:53]
  wire [6:0] requestStages_0_io_data_0_op; // @[AecFpWarpUnits.scala 114:53]
  wire [3:0] requestStages_0_io_data_0_dtype; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_0_io_data_0_a; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_0_io_data_0_b; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_0_io_data_0_c; // @[AecFpWarpUnits.scala 114:53]
  wire [6:0] requestStages_0_io_data_1_op; // @[AecFpWarpUnits.scala 114:53]
  wire [3:0] requestStages_0_io_data_1_dtype; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_0_io_data_1_a; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_0_io_data_1_b; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_0_io_data_1_c; // @[AecFpWarpUnits.scala 114:53]
  wire [6:0] requestStages_0_io_data_2_op; // @[AecFpWarpUnits.scala 114:53]
  wire [3:0] requestStages_0_io_data_2_dtype; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_0_io_data_2_a; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_0_io_data_2_b; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_0_io_data_2_c; // @[AecFpWarpUnits.scala 114:53]
  wire [6:0] requestStages_0_io_data_3_op; // @[AecFpWarpUnits.scala 114:53]
  wire [3:0] requestStages_0_io_data_3_dtype; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_0_io_data_3_a; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_0_io_data_3_b; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_0_io_data_3_c; // @[AecFpWarpUnits.scala 114:53]
  wire  requestStages_0_io_out_ready; // @[AecFpWarpUnits.scala 114:53]
  wire  requestStages_0_io_out_valid; // @[AecFpWarpUnits.scala 114:53]
  wire [6:0] requestStages_0_io_out_bits_op; // @[AecFpWarpUnits.scala 114:53]
  wire [3:0] requestStages_0_io_out_bits_dtype; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_0_io_out_bits_a; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_0_io_out_bits_b; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_0_io_out_bits_c; // @[AecFpWarpUnits.scala 114:53]
  wire  requestStages_1_clock; // @[AecFpWarpUnits.scala 114:53]
  wire  requestStages_1_reset; // @[AecFpWarpUnits.scala 114:53]
  wire  requestStages_1_io_inValid; // @[AecFpWarpUnits.scala 114:53]
  wire  requestStages_1_io_inReady; // @[AecFpWarpUnits.scala 114:53]
  wire [1:0] requestStages_1_io_group; // @[AecFpWarpUnits.scala 114:53]
  wire [6:0] requestStages_1_io_data_0_op; // @[AecFpWarpUnits.scala 114:53]
  wire [3:0] requestStages_1_io_data_0_dtype; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_1_io_data_0_a; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_1_io_data_0_b; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_1_io_data_0_c; // @[AecFpWarpUnits.scala 114:53]
  wire [6:0] requestStages_1_io_data_1_op; // @[AecFpWarpUnits.scala 114:53]
  wire [3:0] requestStages_1_io_data_1_dtype; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_1_io_data_1_a; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_1_io_data_1_b; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_1_io_data_1_c; // @[AecFpWarpUnits.scala 114:53]
  wire [6:0] requestStages_1_io_data_2_op; // @[AecFpWarpUnits.scala 114:53]
  wire [3:0] requestStages_1_io_data_2_dtype; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_1_io_data_2_a; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_1_io_data_2_b; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_1_io_data_2_c; // @[AecFpWarpUnits.scala 114:53]
  wire [6:0] requestStages_1_io_data_3_op; // @[AecFpWarpUnits.scala 114:53]
  wire [3:0] requestStages_1_io_data_3_dtype; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_1_io_data_3_a; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_1_io_data_3_b; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_1_io_data_3_c; // @[AecFpWarpUnits.scala 114:53]
  wire  requestStages_1_io_out_ready; // @[AecFpWarpUnits.scala 114:53]
  wire  requestStages_1_io_out_valid; // @[AecFpWarpUnits.scala 114:53]
  wire [6:0] requestStages_1_io_out_bits_op; // @[AecFpWarpUnits.scala 114:53]
  wire [3:0] requestStages_1_io_out_bits_dtype; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_1_io_out_bits_a; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_1_io_out_bits_b; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_1_io_out_bits_c; // @[AecFpWarpUnits.scala 114:53]
  wire  requestStages_2_clock; // @[AecFpWarpUnits.scala 114:53]
  wire  requestStages_2_reset; // @[AecFpWarpUnits.scala 114:53]
  wire  requestStages_2_io_inValid; // @[AecFpWarpUnits.scala 114:53]
  wire  requestStages_2_io_inReady; // @[AecFpWarpUnits.scala 114:53]
  wire [1:0] requestStages_2_io_group; // @[AecFpWarpUnits.scala 114:53]
  wire [6:0] requestStages_2_io_data_0_op; // @[AecFpWarpUnits.scala 114:53]
  wire [3:0] requestStages_2_io_data_0_dtype; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_2_io_data_0_a; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_2_io_data_0_b; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_2_io_data_0_c; // @[AecFpWarpUnits.scala 114:53]
  wire [6:0] requestStages_2_io_data_1_op; // @[AecFpWarpUnits.scala 114:53]
  wire [3:0] requestStages_2_io_data_1_dtype; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_2_io_data_1_a; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_2_io_data_1_b; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_2_io_data_1_c; // @[AecFpWarpUnits.scala 114:53]
  wire [6:0] requestStages_2_io_data_2_op; // @[AecFpWarpUnits.scala 114:53]
  wire [3:0] requestStages_2_io_data_2_dtype; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_2_io_data_2_a; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_2_io_data_2_b; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_2_io_data_2_c; // @[AecFpWarpUnits.scala 114:53]
  wire [6:0] requestStages_2_io_data_3_op; // @[AecFpWarpUnits.scala 114:53]
  wire [3:0] requestStages_2_io_data_3_dtype; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_2_io_data_3_a; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_2_io_data_3_b; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_2_io_data_3_c; // @[AecFpWarpUnits.scala 114:53]
  wire  requestStages_2_io_out_ready; // @[AecFpWarpUnits.scala 114:53]
  wire  requestStages_2_io_out_valid; // @[AecFpWarpUnits.scala 114:53]
  wire [6:0] requestStages_2_io_out_bits_op; // @[AecFpWarpUnits.scala 114:53]
  wire [3:0] requestStages_2_io_out_bits_dtype; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_2_io_out_bits_a; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_2_io_out_bits_b; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_2_io_out_bits_c; // @[AecFpWarpUnits.scala 114:53]
  wire  requestStages_3_clock; // @[AecFpWarpUnits.scala 114:53]
  wire  requestStages_3_reset; // @[AecFpWarpUnits.scala 114:53]
  wire  requestStages_3_io_inValid; // @[AecFpWarpUnits.scala 114:53]
  wire  requestStages_3_io_inReady; // @[AecFpWarpUnits.scala 114:53]
  wire [1:0] requestStages_3_io_group; // @[AecFpWarpUnits.scala 114:53]
  wire [6:0] requestStages_3_io_data_0_op; // @[AecFpWarpUnits.scala 114:53]
  wire [3:0] requestStages_3_io_data_0_dtype; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_3_io_data_0_a; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_3_io_data_0_b; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_3_io_data_0_c; // @[AecFpWarpUnits.scala 114:53]
  wire [6:0] requestStages_3_io_data_1_op; // @[AecFpWarpUnits.scala 114:53]
  wire [3:0] requestStages_3_io_data_1_dtype; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_3_io_data_1_a; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_3_io_data_1_b; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_3_io_data_1_c; // @[AecFpWarpUnits.scala 114:53]
  wire [6:0] requestStages_3_io_data_2_op; // @[AecFpWarpUnits.scala 114:53]
  wire [3:0] requestStages_3_io_data_2_dtype; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_3_io_data_2_a; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_3_io_data_2_b; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_3_io_data_2_c; // @[AecFpWarpUnits.scala 114:53]
  wire [6:0] requestStages_3_io_data_3_op; // @[AecFpWarpUnits.scala 114:53]
  wire [3:0] requestStages_3_io_data_3_dtype; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_3_io_data_3_a; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_3_io_data_3_b; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_3_io_data_3_c; // @[AecFpWarpUnits.scala 114:53]
  wire  requestStages_3_io_out_ready; // @[AecFpWarpUnits.scala 114:53]
  wire  requestStages_3_io_out_valid; // @[AecFpWarpUnits.scala 114:53]
  wire [6:0] requestStages_3_io_out_bits_op; // @[AecFpWarpUnits.scala 114:53]
  wire [3:0] requestStages_3_io_out_bits_dtype; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_3_io_out_bits_a; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_3_io_out_bits_b; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_3_io_out_bits_c; // @[AecFpWarpUnits.scala 114:53]
  wire  requestStages_4_clock; // @[AecFpWarpUnits.scala 114:53]
  wire  requestStages_4_reset; // @[AecFpWarpUnits.scala 114:53]
  wire  requestStages_4_io_inValid; // @[AecFpWarpUnits.scala 114:53]
  wire  requestStages_4_io_inReady; // @[AecFpWarpUnits.scala 114:53]
  wire [1:0] requestStages_4_io_group; // @[AecFpWarpUnits.scala 114:53]
  wire [6:0] requestStages_4_io_data_0_op; // @[AecFpWarpUnits.scala 114:53]
  wire [3:0] requestStages_4_io_data_0_dtype; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_4_io_data_0_a; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_4_io_data_0_b; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_4_io_data_0_c; // @[AecFpWarpUnits.scala 114:53]
  wire [6:0] requestStages_4_io_data_1_op; // @[AecFpWarpUnits.scala 114:53]
  wire [3:0] requestStages_4_io_data_1_dtype; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_4_io_data_1_a; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_4_io_data_1_b; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_4_io_data_1_c; // @[AecFpWarpUnits.scala 114:53]
  wire [6:0] requestStages_4_io_data_2_op; // @[AecFpWarpUnits.scala 114:53]
  wire [3:0] requestStages_4_io_data_2_dtype; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_4_io_data_2_a; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_4_io_data_2_b; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_4_io_data_2_c; // @[AecFpWarpUnits.scala 114:53]
  wire [6:0] requestStages_4_io_data_3_op; // @[AecFpWarpUnits.scala 114:53]
  wire [3:0] requestStages_4_io_data_3_dtype; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_4_io_data_3_a; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_4_io_data_3_b; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_4_io_data_3_c; // @[AecFpWarpUnits.scala 114:53]
  wire  requestStages_4_io_out_ready; // @[AecFpWarpUnits.scala 114:53]
  wire  requestStages_4_io_out_valid; // @[AecFpWarpUnits.scala 114:53]
  wire [6:0] requestStages_4_io_out_bits_op; // @[AecFpWarpUnits.scala 114:53]
  wire [3:0] requestStages_4_io_out_bits_dtype; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_4_io_out_bits_a; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_4_io_out_bits_b; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_4_io_out_bits_c; // @[AecFpWarpUnits.scala 114:53]
  wire  requestStages_5_clock; // @[AecFpWarpUnits.scala 114:53]
  wire  requestStages_5_reset; // @[AecFpWarpUnits.scala 114:53]
  wire  requestStages_5_io_inValid; // @[AecFpWarpUnits.scala 114:53]
  wire  requestStages_5_io_inReady; // @[AecFpWarpUnits.scala 114:53]
  wire [1:0] requestStages_5_io_group; // @[AecFpWarpUnits.scala 114:53]
  wire [6:0] requestStages_5_io_data_0_op; // @[AecFpWarpUnits.scala 114:53]
  wire [3:0] requestStages_5_io_data_0_dtype; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_5_io_data_0_a; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_5_io_data_0_b; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_5_io_data_0_c; // @[AecFpWarpUnits.scala 114:53]
  wire [6:0] requestStages_5_io_data_1_op; // @[AecFpWarpUnits.scala 114:53]
  wire [3:0] requestStages_5_io_data_1_dtype; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_5_io_data_1_a; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_5_io_data_1_b; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_5_io_data_1_c; // @[AecFpWarpUnits.scala 114:53]
  wire [6:0] requestStages_5_io_data_2_op; // @[AecFpWarpUnits.scala 114:53]
  wire [3:0] requestStages_5_io_data_2_dtype; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_5_io_data_2_a; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_5_io_data_2_b; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_5_io_data_2_c; // @[AecFpWarpUnits.scala 114:53]
  wire [6:0] requestStages_5_io_data_3_op; // @[AecFpWarpUnits.scala 114:53]
  wire [3:0] requestStages_5_io_data_3_dtype; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_5_io_data_3_a; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_5_io_data_3_b; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_5_io_data_3_c; // @[AecFpWarpUnits.scala 114:53]
  wire  requestStages_5_io_out_ready; // @[AecFpWarpUnits.scala 114:53]
  wire  requestStages_5_io_out_valid; // @[AecFpWarpUnits.scala 114:53]
  wire [6:0] requestStages_5_io_out_bits_op; // @[AecFpWarpUnits.scala 114:53]
  wire [3:0] requestStages_5_io_out_bits_dtype; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_5_io_out_bits_a; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_5_io_out_bits_b; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_5_io_out_bits_c; // @[AecFpWarpUnits.scala 114:53]
  wire  requestStages_6_clock; // @[AecFpWarpUnits.scala 114:53]
  wire  requestStages_6_reset; // @[AecFpWarpUnits.scala 114:53]
  wire  requestStages_6_io_inValid; // @[AecFpWarpUnits.scala 114:53]
  wire  requestStages_6_io_inReady; // @[AecFpWarpUnits.scala 114:53]
  wire [1:0] requestStages_6_io_group; // @[AecFpWarpUnits.scala 114:53]
  wire [6:0] requestStages_6_io_data_0_op; // @[AecFpWarpUnits.scala 114:53]
  wire [3:0] requestStages_6_io_data_0_dtype; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_6_io_data_0_a; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_6_io_data_0_b; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_6_io_data_0_c; // @[AecFpWarpUnits.scala 114:53]
  wire [6:0] requestStages_6_io_data_1_op; // @[AecFpWarpUnits.scala 114:53]
  wire [3:0] requestStages_6_io_data_1_dtype; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_6_io_data_1_a; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_6_io_data_1_b; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_6_io_data_1_c; // @[AecFpWarpUnits.scala 114:53]
  wire [6:0] requestStages_6_io_data_2_op; // @[AecFpWarpUnits.scala 114:53]
  wire [3:0] requestStages_6_io_data_2_dtype; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_6_io_data_2_a; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_6_io_data_2_b; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_6_io_data_2_c; // @[AecFpWarpUnits.scala 114:53]
  wire [6:0] requestStages_6_io_data_3_op; // @[AecFpWarpUnits.scala 114:53]
  wire [3:0] requestStages_6_io_data_3_dtype; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_6_io_data_3_a; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_6_io_data_3_b; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_6_io_data_3_c; // @[AecFpWarpUnits.scala 114:53]
  wire  requestStages_6_io_out_ready; // @[AecFpWarpUnits.scala 114:53]
  wire  requestStages_6_io_out_valid; // @[AecFpWarpUnits.scala 114:53]
  wire [6:0] requestStages_6_io_out_bits_op; // @[AecFpWarpUnits.scala 114:53]
  wire [3:0] requestStages_6_io_out_bits_dtype; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_6_io_out_bits_a; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_6_io_out_bits_b; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_6_io_out_bits_c; // @[AecFpWarpUnits.scala 114:53]
  wire  requestStages_7_clock; // @[AecFpWarpUnits.scala 114:53]
  wire  requestStages_7_reset; // @[AecFpWarpUnits.scala 114:53]
  wire  requestStages_7_io_inValid; // @[AecFpWarpUnits.scala 114:53]
  wire  requestStages_7_io_inReady; // @[AecFpWarpUnits.scala 114:53]
  wire [1:0] requestStages_7_io_group; // @[AecFpWarpUnits.scala 114:53]
  wire [6:0] requestStages_7_io_data_0_op; // @[AecFpWarpUnits.scala 114:53]
  wire [3:0] requestStages_7_io_data_0_dtype; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_7_io_data_0_a; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_7_io_data_0_b; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_7_io_data_0_c; // @[AecFpWarpUnits.scala 114:53]
  wire [6:0] requestStages_7_io_data_1_op; // @[AecFpWarpUnits.scala 114:53]
  wire [3:0] requestStages_7_io_data_1_dtype; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_7_io_data_1_a; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_7_io_data_1_b; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_7_io_data_1_c; // @[AecFpWarpUnits.scala 114:53]
  wire [6:0] requestStages_7_io_data_2_op; // @[AecFpWarpUnits.scala 114:53]
  wire [3:0] requestStages_7_io_data_2_dtype; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_7_io_data_2_a; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_7_io_data_2_b; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_7_io_data_2_c; // @[AecFpWarpUnits.scala 114:53]
  wire [6:0] requestStages_7_io_data_3_op; // @[AecFpWarpUnits.scala 114:53]
  wire [3:0] requestStages_7_io_data_3_dtype; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_7_io_data_3_a; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_7_io_data_3_b; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_7_io_data_3_c; // @[AecFpWarpUnits.scala 114:53]
  wire  requestStages_7_io_out_ready; // @[AecFpWarpUnits.scala 114:53]
  wire  requestStages_7_io_out_valid; // @[AecFpWarpUnits.scala 114:53]
  wire [6:0] requestStages_7_io_out_bits_op; // @[AecFpWarpUnits.scala 114:53]
  wire [3:0] requestStages_7_io_out_bits_dtype; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_7_io_out_bits_a; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_7_io_out_bits_b; // @[AecFpWarpUnits.scala 114:53]
  wire [63:0] requestStages_7_io_out_bits_c; // @[AecFpWarpUnits.scala 114:53]
  wire  requestBuffer_clock; // @[AecFpWarpUnits.scala 116:64]
  wire  requestBuffer_reset; // @[AecFpWarpUnits.scala 116:64]
  wire [15:0] requestBuffer_io_in_op; // @[AecFpWarpUnits.scala 116:64]
  wire [3:0] requestBuffer_io_in_dtype; // @[AecFpWarpUnits.scala 116:64]
  wire [31:0] requestBuffer_io_in_activeMask; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_a_0; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_a_1; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_a_2; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_a_3; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_a_4; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_a_5; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_a_6; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_a_7; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_a_8; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_a_9; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_a_10; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_a_11; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_a_12; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_a_13; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_a_14; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_a_15; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_a_16; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_a_17; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_a_18; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_a_19; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_a_20; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_a_21; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_a_22; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_a_23; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_a_24; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_a_25; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_a_26; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_a_27; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_a_28; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_a_29; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_a_30; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_a_31; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_b_0; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_b_1; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_b_2; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_b_3; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_b_4; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_b_5; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_b_6; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_b_7; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_b_8; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_b_9; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_b_10; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_b_11; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_b_12; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_b_13; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_b_14; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_b_15; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_b_16; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_b_17; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_b_18; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_b_19; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_b_20; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_b_21; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_b_22; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_b_23; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_b_24; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_b_25; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_b_26; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_b_27; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_b_28; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_b_29; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_b_30; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_b_31; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_c_0; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_c_1; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_c_2; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_c_3; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_c_4; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_c_5; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_c_6; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_c_7; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_c_8; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_c_9; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_c_10; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_c_11; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_c_12; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_c_13; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_c_14; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_c_15; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_c_16; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_c_17; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_c_18; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_c_19; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_c_20; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_c_21; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_c_22; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_c_23; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_c_24; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_c_25; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_c_26; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_c_27; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_c_28; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_c_29; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_c_30; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_in_c_31; // @[AecFpWarpUnits.scala 116:64]
  wire [7:0] requestBuffer_io_in_dest; // @[AecFpWarpUnits.scala 116:64]
  wire  requestBuffer_io_arm_0; // @[AecFpWarpUnits.scala 116:64]
  wire  requestBuffer_io_arm_1; // @[AecFpWarpUnits.scala 116:64]
  wire  requestBuffer_io_arm_2; // @[AecFpWarpUnits.scala 116:64]
  wire  requestBuffer_io_arm_3; // @[AecFpWarpUnits.scala 116:64]
  wire  requestBuffer_io_arm_4; // @[AecFpWarpUnits.scala 116:64]
  wire  requestBuffer_io_arm_5; // @[AecFpWarpUnits.scala 116:64]
  wire  requestBuffer_io_arm_6; // @[AecFpWarpUnits.scala 116:64]
  wire  requestBuffer_io_arm_7; // @[AecFpWarpUnits.scala 116:64]
  wire  requestBuffer_io_capture; // @[AecFpWarpUnits.scala 116:64]
  wire [15:0] requestBuffer_io_out_op; // @[AecFpWarpUnits.scala 116:64]
  wire [3:0] requestBuffer_io_out_dtype; // @[AecFpWarpUnits.scala 116:64]
  wire [31:0] requestBuffer_io_out_activeMask; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_a_0; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_a_1; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_a_2; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_a_3; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_a_4; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_a_5; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_a_6; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_a_7; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_a_8; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_a_9; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_a_10; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_a_11; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_a_12; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_a_13; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_a_14; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_a_15; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_a_16; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_a_17; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_a_18; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_a_19; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_a_20; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_a_21; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_a_22; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_a_23; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_a_24; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_a_25; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_a_26; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_a_27; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_a_28; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_a_29; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_a_30; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_a_31; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_b_0; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_b_1; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_b_2; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_b_3; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_b_4; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_b_5; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_b_6; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_b_7; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_b_8; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_b_9; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_b_10; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_b_11; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_b_12; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_b_13; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_b_14; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_b_15; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_b_16; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_b_17; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_b_18; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_b_19; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_b_20; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_b_21; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_b_22; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_b_23; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_b_24; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_b_25; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_b_26; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_b_27; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_b_28; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_b_29; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_b_30; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_b_31; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_c_0; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_c_1; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_c_2; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_c_3; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_c_4; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_c_5; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_c_6; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_c_7; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_c_8; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_c_9; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_c_10; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_c_11; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_c_12; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_c_13; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_c_14; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_c_15; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_c_16; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_c_17; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_c_18; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_c_19; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_c_20; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_c_21; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_c_22; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_c_23; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_c_24; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_c_25; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_c_26; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_c_27; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_c_28; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_c_29; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_c_30; // @[AecFpWarpUnits.scala 116:64]
  wire [63:0] requestBuffer_io_out_c_31; // @[AecFpWarpUnits.scala 116:64]
  wire [7:0] requestBuffer_io_out_dest; // @[AecFpWarpUnits.scala 116:64]
  wire  resultBanks_0_clock; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_0_reset; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_0_io_write; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_0_io_writeResult; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_0_io_writeFlags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_0_io_writePredicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_0_io_writeError; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_0_io_result; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_0_io_flags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_0_io_predicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_0_io_error; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_1_clock; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_1_reset; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_1_io_write; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_1_io_writeResult; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_1_io_writeFlags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_1_io_writePredicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_1_io_writeError; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_1_io_result; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_1_io_flags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_1_io_predicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_1_io_error; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_2_clock; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_2_reset; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_2_io_write; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_2_io_writeResult; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_2_io_writeFlags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_2_io_writePredicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_2_io_writeError; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_2_io_result; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_2_io_flags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_2_io_predicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_2_io_error; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_3_clock; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_3_reset; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_3_io_write; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_3_io_writeResult; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_3_io_writeFlags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_3_io_writePredicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_3_io_writeError; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_3_io_result; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_3_io_flags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_3_io_predicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_3_io_error; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_4_clock; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_4_reset; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_4_io_write; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_4_io_writeResult; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_4_io_writeFlags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_4_io_writePredicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_4_io_writeError; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_4_io_result; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_4_io_flags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_4_io_predicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_4_io_error; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_5_clock; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_5_reset; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_5_io_write; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_5_io_writeResult; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_5_io_writeFlags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_5_io_writePredicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_5_io_writeError; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_5_io_result; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_5_io_flags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_5_io_predicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_5_io_error; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_6_clock; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_6_reset; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_6_io_write; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_6_io_writeResult; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_6_io_writeFlags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_6_io_writePredicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_6_io_writeError; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_6_io_result; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_6_io_flags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_6_io_predicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_6_io_error; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_7_clock; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_7_reset; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_7_io_write; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_7_io_writeResult; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_7_io_writeFlags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_7_io_writePredicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_7_io_writeError; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_7_io_result; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_7_io_flags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_7_io_predicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_7_io_error; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_8_clock; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_8_reset; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_8_io_write; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_8_io_writeResult; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_8_io_writeFlags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_8_io_writePredicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_8_io_writeError; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_8_io_result; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_8_io_flags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_8_io_predicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_8_io_error; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_9_clock; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_9_reset; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_9_io_write; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_9_io_writeResult; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_9_io_writeFlags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_9_io_writePredicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_9_io_writeError; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_9_io_result; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_9_io_flags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_9_io_predicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_9_io_error; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_10_clock; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_10_reset; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_10_io_write; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_10_io_writeResult; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_10_io_writeFlags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_10_io_writePredicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_10_io_writeError; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_10_io_result; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_10_io_flags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_10_io_predicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_10_io_error; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_11_clock; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_11_reset; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_11_io_write; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_11_io_writeResult; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_11_io_writeFlags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_11_io_writePredicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_11_io_writeError; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_11_io_result; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_11_io_flags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_11_io_predicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_11_io_error; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_12_clock; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_12_reset; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_12_io_write; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_12_io_writeResult; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_12_io_writeFlags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_12_io_writePredicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_12_io_writeError; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_12_io_result; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_12_io_flags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_12_io_predicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_12_io_error; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_13_clock; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_13_reset; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_13_io_write; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_13_io_writeResult; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_13_io_writeFlags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_13_io_writePredicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_13_io_writeError; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_13_io_result; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_13_io_flags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_13_io_predicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_13_io_error; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_14_clock; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_14_reset; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_14_io_write; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_14_io_writeResult; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_14_io_writeFlags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_14_io_writePredicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_14_io_writeError; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_14_io_result; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_14_io_flags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_14_io_predicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_14_io_error; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_15_clock; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_15_reset; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_15_io_write; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_15_io_writeResult; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_15_io_writeFlags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_15_io_writePredicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_15_io_writeError; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_15_io_result; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_15_io_flags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_15_io_predicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_15_io_error; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_16_clock; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_16_reset; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_16_io_write; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_16_io_writeResult; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_16_io_writeFlags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_16_io_writePredicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_16_io_writeError; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_16_io_result; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_16_io_flags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_16_io_predicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_16_io_error; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_17_clock; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_17_reset; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_17_io_write; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_17_io_writeResult; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_17_io_writeFlags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_17_io_writePredicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_17_io_writeError; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_17_io_result; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_17_io_flags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_17_io_predicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_17_io_error; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_18_clock; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_18_reset; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_18_io_write; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_18_io_writeResult; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_18_io_writeFlags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_18_io_writePredicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_18_io_writeError; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_18_io_result; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_18_io_flags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_18_io_predicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_18_io_error; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_19_clock; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_19_reset; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_19_io_write; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_19_io_writeResult; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_19_io_writeFlags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_19_io_writePredicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_19_io_writeError; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_19_io_result; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_19_io_flags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_19_io_predicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_19_io_error; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_20_clock; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_20_reset; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_20_io_write; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_20_io_writeResult; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_20_io_writeFlags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_20_io_writePredicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_20_io_writeError; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_20_io_result; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_20_io_flags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_20_io_predicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_20_io_error; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_21_clock; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_21_reset; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_21_io_write; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_21_io_writeResult; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_21_io_writeFlags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_21_io_writePredicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_21_io_writeError; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_21_io_result; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_21_io_flags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_21_io_predicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_21_io_error; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_22_clock; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_22_reset; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_22_io_write; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_22_io_writeResult; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_22_io_writeFlags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_22_io_writePredicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_22_io_writeError; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_22_io_result; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_22_io_flags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_22_io_predicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_22_io_error; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_23_clock; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_23_reset; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_23_io_write; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_23_io_writeResult; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_23_io_writeFlags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_23_io_writePredicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_23_io_writeError; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_23_io_result; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_23_io_flags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_23_io_predicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_23_io_error; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_24_clock; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_24_reset; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_24_io_write; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_24_io_writeResult; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_24_io_writeFlags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_24_io_writePredicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_24_io_writeError; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_24_io_result; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_24_io_flags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_24_io_predicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_24_io_error; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_25_clock; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_25_reset; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_25_io_write; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_25_io_writeResult; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_25_io_writeFlags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_25_io_writePredicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_25_io_writeError; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_25_io_result; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_25_io_flags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_25_io_predicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_25_io_error; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_26_clock; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_26_reset; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_26_io_write; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_26_io_writeResult; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_26_io_writeFlags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_26_io_writePredicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_26_io_writeError; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_26_io_result; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_26_io_flags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_26_io_predicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_26_io_error; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_27_clock; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_27_reset; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_27_io_write; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_27_io_writeResult; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_27_io_writeFlags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_27_io_writePredicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_27_io_writeError; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_27_io_result; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_27_io_flags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_27_io_predicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_27_io_error; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_28_clock; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_28_reset; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_28_io_write; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_28_io_writeResult; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_28_io_writeFlags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_28_io_writePredicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_28_io_writeError; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_28_io_result; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_28_io_flags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_28_io_predicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_28_io_error; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_29_clock; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_29_reset; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_29_io_write; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_29_io_writeResult; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_29_io_writeFlags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_29_io_writePredicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_29_io_writeError; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_29_io_result; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_29_io_flags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_29_io_predicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_29_io_error; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_30_clock; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_30_reset; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_30_io_write; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_30_io_writeResult; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_30_io_writeFlags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_30_io_writePredicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_30_io_writeError; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_30_io_result; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_30_io_flags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_30_io_predicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_30_io_error; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_31_clock; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_31_reset; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_31_io_write; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_31_io_writeResult; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_31_io_writeFlags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_31_io_writePredicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_31_io_writeError; // @[AecFpWarpUnits.scala 128:40]
  wire [63:0] resultBanks_31_io_result; // @[AecFpWarpUnits.scala 128:40]
  wire [4:0] resultBanks_31_io_flags; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_31_io_predicate; // @[AecFpWarpUnits.scala 128:40]
  wire  resultBanks_31_io_error; // @[AecFpWarpUnits.scala 128:40]
  reg  capturePending; // @[AecFpWarpUnits.scala 123:31]
  reg [1:0] group; // @[AecFpWarpUnits.scala 124:22]
  reg  outValid; // @[AecFpWarpUnits.scala 124:91]
  reg  running; // @[AecFpWarpUnits.scala 125:24]
  reg  groupIssued; // @[AecFpWarpUnits.scala 126:28]
  reg  commitPending; // @[AecFpWarpUnits.scala 127:30]
  wire  allReady = requestStages_0_io_inReady & requestStages_1_io_inReady & requestStages_2_io_inReady &
    ...
    requestStages_7_io_inReady; // @[AecFpWarpUnits.scala 129:59]
  wire  allValid = pipes_0_io_resp_valid & pipes_1_io_resp_valid & pipes_2_io_resp_valid & pipes_3_io_resp_valid &
    pipes_4_io_resp_valid & pipes_5_io_resp_valid & pipes_6_io_resp_valid & pipes_7_io_resp_valid; // @[AecFpWarpUnits.scala 129:117]
  reg  armPending; // @[AecFpWarpUnits.scala 130:27]
  wire  _armCapture_T_5 = ~outValid; // @[AecFpWarpUnits.scala 132:51]
  wire  armCapture = ~armPending & ~capturePending & ~running & ~outValid & io_req_valid; // @[AecFpWarpUnits.scala 132:61]
  reg  armClusters_0; // @[AecFpWarpUnits.scala 134:30]
  reg  armClusters_1; // @[AecFpWarpUnits.scala 134:30]
  reg  armClusters_2; // @[AecFpWarpUnits.scala 134:30]
  reg  armClusters_3; // @[AecFpWarpUnits.scala 134:30]
  reg  armClusters_4; // @[AecFpWarpUnits.scala 134:30]
  reg  armClusters_5; // @[AecFpWarpUnits.scala 134:30]
  reg  armClusters_6; // @[AecFpWarpUnits.scala 134:30]
  reg  armClusters_7; // @[AecFpWarpUnits.scala 134:30]
  wire  _requestBuffer_io_capture_T = io_req_ready & io_req_valid; // @[Decoupled.scala 51:35]
  wire  _io_resp_bits_predicateMask_WIRE_1 = resultBanks_1_io_predicate; // @[AecFpWarpUnits.scala 143:{40,40}]
  wire  _io_resp_bits_predicateMask_WIRE_0 = resultBanks_0_io_predicate; // @[AecFpWarpUnits.scala 143:{40,40}]
  wire  _io_resp_bits_predicateMask_WIRE_3 = resultBanks_3_io_predicate; // @[AecFpWarpUnits.scala 143:{40,40}]
  wire  _io_resp_bits_predicateMask_WIRE_2 = resultBanks_2_io_predicate; // @[AecFpWarpUnits.scala 143:{40,40}]
  wire  _io_resp_bits_predicateMask_WIRE_5 = resultBanks_5_io_predicate; // @[AecFpWarpUnits.scala 143:{40,40}]
  wire  _io_resp_bits_predicateMask_WIRE_4 = resultBanks_4_io_predicate; // @[AecFpWarpUnits.scala 143:{40,40}]
  wire  _io_resp_bits_predicateMask_WIRE_7 = resultBanks_7_io_predicate; // @[AecFpWarpUnits.scala 143:{40,40}]
  wire  _io_resp_bits_predicateMask_WIRE_6 = resultBanks_6_io_predicate; // @[AecFpWarpUnits.scala 143:{40,40}]
  wire [7:0] io_resp_bits_predicateMask_lo_lo = {_io_resp_bits_predicateMask_WIRE_7,_io_resp_bits_predicateMask_WIRE_6,
    ...
    _io_resp_bits_predicateMask_WIRE_2,_io_resp_bits_predicateMask_WIRE_1,_io_resp_bits_predicateMask_WIRE_0}; // @[AecFpWarpUnits.scala 143:74]
  wire  _io_resp_bits_predicateMask_WIRE_9 = resultBanks_9_io_predicate; // @[AecFpWarpUnits.scala 143:{40,40}]
  wire  _io_resp_bits_predicateMask_WIRE_8 = resultBanks_8_io_predicate; // @[AecFpWarpUnits.scala 143:{40,40}]
  wire  _io_resp_bits_predicateMask_WIRE_11 = resultBanks_11_io_predicate; // @[AecFpWarpUnits.scala 143:{40,40}]
  wire  _io_resp_bits_predicateMask_WIRE_10 = resultBanks_10_io_predicate; // @[AecFpWarpUnits.scala 143:{40,40}]
  wire  _io_resp_bits_predicateMask_WIRE_13 = resultBanks_13_io_predicate; // @[AecFpWarpUnits.scala 143:{40,40}]
  wire  _io_resp_bits_predicateMask_WIRE_12 = resultBanks_12_io_predicate; // @[AecFpWarpUnits.scala 143:{40,40}]
  wire  _io_resp_bits_predicateMask_WIRE_15 = resultBanks_15_io_predicate; // @[AecFpWarpUnits.scala 143:{40,40}]
  wire  _io_resp_bits_predicateMask_WIRE_14 = resultBanks_14_io_predicate; // @[AecFpWarpUnits.scala 143:{40,40}]
  wire [15:0] io_resp_bits_predicateMask_lo = {_io_resp_bits_predicateMask_WIRE_15,_io_resp_bits_predicateMask_WIRE_14,
    ...
    io_resp_bits_predicateMask_lo_lo}; // @[AecFpWarpUnits.scala 143:74]
  wire  _io_resp_bits_predicateMask_WIRE_17 = resultBanks_17_io_predicate; // @[AecFpWarpUnits.scala 143:{40,40}]
  wire  _io_resp_bits_predicateMask_WIRE_16 = resultBanks_16_io_predicate; // @[AecFpWarpUnits.scala 143:{40,40}]
  wire  _io_resp_bits_predicateMask_WIRE_19 = resultBanks_19_io_predicate; // @[AecFpWarpUnits.scala 143:{40,40}]
  wire  _io_resp_bits_predicateMask_WIRE_18 = resultBanks_18_io_predicate; // @[AecFpWarpUnits.scala 143:{40,40}]
  wire  _io_resp_bits_predicateMask_WIRE_21 = resultBanks_21_io_predicate; // @[AecFpWarpUnits.scala 143:{40,40}]
  wire  _io_resp_bits_predicateMask_WIRE_20 = resultBanks_20_io_predicate; // @[AecFpWarpUnits.scala 143:{40,40}]
  wire  _io_resp_bits_predicateMask_WIRE_23 = resultBanks_23_io_predicate; // @[AecFpWarpUnits.scala 143:{40,40}]
  wire  _io_resp_bits_predicateMask_WIRE_22 = resultBanks_22_io_predicate; // @[AecFpWarpUnits.scala 143:{40,40}]
  wire [7:0] io_resp_bits_predicateMask_hi_lo = {_io_resp_bits_predicateMask_WIRE_23,_io_resp_bits_predicateMask_WIRE_22
    ...
    _io_resp_bits_predicateMask_WIRE_18,_io_resp_bits_predicateMask_WIRE_17,_io_resp_bits_predicateMask_WIRE_16}; // @[AecFpWarpUnits.scala 143:74]
  wire  _io_resp_bits_predicateMask_WIRE_25 = resultBanks_25_io_predicate; // @[AecFpWarpUnits.scala 143:{40,40}]
  wire  _io_resp_bits_predicateMask_WIRE_24 = resultBanks_24_io_predicate; // @[AecFpWarpUnits.scala 143:{40,40}]
  wire  _io_resp_bits_predicateMask_WIRE_27 = resultBanks_27_io_predicate; // @[AecFpWarpUnits.scala 143:{40,40}]
  wire  _io_resp_bits_predicateMask_WIRE_26 = resultBanks_26_io_predicate; // @[AecFpWarpUnits.scala 143:{40,40}]
  wire  _io_resp_bits_predicateMask_WIRE_29 = resultBanks_29_io_predicate; // @[AecFpWarpUnits.scala 143:{40,40}]
  wire  _io_resp_bits_predicateMask_WIRE_28 = resultBanks_28_io_predicate; // @[AecFpWarpUnits.scala 143:{40,40}]
  wire  _io_resp_bits_predicateMask_WIRE_31 = resultBanks_31_io_predicate; // @[AecFpWarpUnits.scala 143:{40,40}]
  wire  _io_resp_bits_predicateMask_WIRE_30 = resultBanks_30_io_predicate; // @[AecFpWarpUnits.scala 143:{40,40}]
  wire [15:0] io_resp_bits_predicateMask_hi = {_io_resp_bits_predicateMask_WIRE_31,_io_resp_bits_predicateMask_WIRE_30,
    ...
    io_resp_bits_predicateMask_hi_lo}; // @[AecFpWarpUnits.scala 143:74]
  wire  _io_resp_bits_errorMask_WIRE_1 = resultBanks_1_io_error; // @[AecFpWarpUnits.scala 144:{36,36}]
  wire  _io_resp_bits_errorMask_WIRE_0 = resultBanks_0_io_error; // @[AecFpWarpUnits.scala 144:{36,36}]
  wire  _io_resp_bits_errorMask_WIRE_3 = resultBanks_3_io_error; // @[AecFpWarpUnits.scala 144:{36,36}]
  wire  _io_resp_bits_errorMask_WIRE_2 = resultBanks_2_io_error; // @[AecFpWarpUnits.scala 144:{36,36}]
  wire  _io_resp_bits_errorMask_WIRE_5 = resultBanks_5_io_error; // @[AecFpWarpUnits.scala 144:{36,36}]
  wire  _io_resp_bits_errorMask_WIRE_4 = resultBanks_4_io_error; // @[AecFpWarpUnits.scala 144:{36,36}]
  wire  _io_resp_bits_errorMask_WIRE_7 = resultBanks_7_io_error; // @[AecFpWarpUnits.scala 144:{36,36}]
  wire  _io_resp_bits_errorMask_WIRE_6 = resultBanks_6_io_error; // @[AecFpWarpUnits.scala 144:{36,36}]
  wire [7:0] io_resp_bits_errorMask_lo_lo = {_io_resp_bits_errorMask_WIRE_7,_io_resp_bits_errorMask_WIRE_6,
    ...
    _io_resp_bits_errorMask_WIRE_2,_io_resp_bits_errorMask_WIRE_1,_io_resp_bits_errorMask_WIRE_0}; // @[AecFpWarpUnits.scala 144:66]
  wire  _io_resp_bits_errorMask_WIRE_9 = resultBanks_9_io_error; // @[AecFpWarpUnits.scala 144:{36,36}]
  wire  _io_resp_bits_errorMask_WIRE_8 = resultBanks_8_io_error; // @[AecFpWarpUnits.scala 144:{36,36}]
  wire  _io_resp_bits_errorMask_WIRE_11 = resultBanks_11_io_error; // @[AecFpWarpUnits.scala 144:{36,36}]
  wire  _io_resp_bits_errorMask_WIRE_10 = resultBanks_10_io_error; // @[AecFpWarpUnits.scala 144:{36,36}]
  wire  _io_resp_bits_errorMask_WIRE_13 = resultBanks_13_io_error; // @[AecFpWarpUnits.scala 144:{36,36}]
  wire  _io_resp_bits_errorMask_WIRE_12 = resultBanks_12_io_error; // @[AecFpWarpUnits.scala 144:{36,36}]
  wire  _io_resp_bits_errorMask_WIRE_15 = resultBanks_15_io_error; // @[AecFpWarpUnits.scala 144:{36,36}]
  wire  _io_resp_bits_errorMask_WIRE_14 = resultBanks_14_io_error; // @[AecFpWarpUnits.scala 144:{36,36}]
  wire [15:0] io_resp_bits_errorMask_lo = {_io_resp_bits_errorMask_WIRE_15,_io_resp_bits_errorMask_WIRE_14,
    ...
    io_resp_bits_errorMask_lo_lo}; // @[AecFpWarpUnits.scala 144:66]
  wire  _io_resp_bits_errorMask_WIRE_17 = resultBanks_17_io_error; // @[AecFpWarpUnits.scala 144:{36,36}]
  wire  _io_resp_bits_errorMask_WIRE_16 = resultBanks_16_io_error; // @[AecFpWarpUnits.scala 144:{36,36}]
  wire  _io_resp_bits_errorMask_WIRE_19 = resultBanks_19_io_error; // @[AecFpWarpUnits.scala 144:{36,36}]
  wire  _io_resp_bits_errorMask_WIRE_18 = resultBanks_18_io_error; // @[AecFpWarpUnits.scala 144:{36,36}]
  wire  _io_resp_bits_errorMask_WIRE_21 = resultBanks_21_io_error; // @[AecFpWarpUnits.scala 144:{36,36}]
  wire  _io_resp_bits_errorMask_WIRE_20 = resultBanks_20_io_error; // @[AecFpWarpUnits.scala 144:{36,36}]
  wire  _io_resp_bits_errorMask_WIRE_23 = resultBanks_23_io_error; // @[AecFpWarpUnits.scala 144:{36,36}]
  wire  _io_resp_bits_errorMask_WIRE_22 = resultBanks_22_io_error; // @[AecFpWarpUnits.scala 144:{36,36}]
  wire [7:0] io_resp_bits_errorMask_hi_lo = {_io_resp_bits_errorMask_WIRE_23,_io_resp_bits_errorMask_WIRE_22,
    ...
    _io_resp_bits_errorMask_WIRE_18,_io_resp_bits_errorMask_WIRE_17,_io_resp_bits_errorMask_WIRE_16}; // @[AecFpWarpUnits.scala 144:66]
  wire  _io_resp_bits_errorMask_WIRE_25 = resultBanks_25_io_error; // @[AecFpWarpUnits.scala 144:{36,36}]
  wire  _io_resp_bits_errorMask_WIRE_24 = resultBanks_24_io_error; // @[AecFpWarpUnits.scala 144:{36,36}]
  wire  _io_resp_bits_errorMask_WIRE_27 = resultBanks_27_io_error; // @[AecFpWarpUnits.scala 144:{36,36}]
  wire  _io_resp_bits_errorMask_WIRE_26 = resultBanks_26_io_error; // @[AecFpWarpUnits.scala 144:{36,36}]
  wire  _io_resp_bits_errorMask_WIRE_29 = resultBanks_29_io_error; // @[AecFpWarpUnits.scala 144:{36,36}]
  wire  _io_resp_bits_errorMask_WIRE_28 = resultBanks_28_io_error; // @[AecFpWarpUnits.scala 144:{36,36}]
  wire  _io_resp_bits_errorMask_WIRE_31 = resultBanks_31_io_error; // @[AecFpWarpUnits.scala 144:{36,36}]
  wire  _io_resp_bits_errorMask_WIRE_30 = resultBanks_30_io_error; // @[AecFpWarpUnits.scala 144:{36,36}]
  wire [15:0] io_resp_bits_errorMask_hi = {_io_resp_bits_errorMask_WIRE_31,_io_resp_bits_errorMask_WIRE_30,
    ...
    io_resp_bits_errorMask_hi_lo}; // @[AecFpWarpUnits.scala 144:66]
  wire  _requestStages_0_io_inValid_T_1 = running & ~groupIssued; // @[AecFpWarpUnits.scala 148:44]
  wire [15:0] held_op = requestBuffer_io_out_op; // @[AecFpWarpUnits.scala 115:18 119:10]
  wire [31:0] held_activeMask = requestBuffer_io_out_activeMask; // @[AecFpWarpUnits.scala 115:18 119:10]
  wire  _resultBanks_24_io_write_T_3 = group == 2'h3; // @[AecFpWarpUnits.scala 164:90]
  wire  _GEN_0 = armPending | capturePending; // @[AecFpWarpUnits.scala 172:23 123:31 172:40]
  wire  _GEN_3 = _requestBuffer_io_capture_T ? 1'h0 : groupIssued; // @[AecFpWarpUnits.scala 174:22 176:17 126:28]
  wire  _GEN_4 = _requestBuffer_io_capture_T ? 1'h0 : commitPending; // @[AecFpWarpUnits.scala 174:22 177:19 127:30]
  wire  _GEN_5 = _requestBuffer_io_capture_T | running; // @[AecFpWarpUnits.scala 174:22 178:13 125:24]
  wire  _GEN_6 = _requestBuffer_io_capture_T ? 1'h0 : outValid; // @[AecFpWarpUnits.scala 174:22 179:14 124:91]
  wire  _T_3 = ~commitPending; // @[AecFpWarpUnits.scala 181:36]
  wire  _GEN_7 = _requestStages_0_io_inValid_T_1 & ~commitPending & allReady | _GEN_3; // @[AecFpWarpUnits.scala 181:{64,78}]
  wire  _GEN_8 = running & groupIssued & _T_3 & allValid | _GEN_4; // @[AecFpWarpUnits.scala 182:63 183:19]
  wire [1:0] _group_T_1 = group + 2'h1; // @[AecFpWarpUnits.scala 188:121]
  wire  _GEN_9 = _resultBanks_24_io_write_T_3 | _GEN_6; // @[AecFpWarpUnits.scala 188:{37,48}]
  wire  _T_11 = io_resp_ready & io_resp_valid; // @[Decoupled.scala 51:35]
  AecFp64PipeUnit pipes_0 ( // @[AecFpWarpUnits.scala 112:45]
    .clock(pipes_0_clock),
    .reset(pipes_0_reset),
  ...
  AecFp64PipeUnit pipes_1 ( // @[AecFpWarpUnits.scala 112:45]
    .clock(pipes_1_clock),
    .reset(pipes_1_reset),
  ...
  AecFp64PipeUnit pipes_2 ( // @[AecFpWarpUnits.scala 112:45]
    .clock(pipes_2_clock),
    .reset(pipes_2_reset),
  ...
  AecFp64PipeUnit pipes_3 ( // @[AecFpWarpUnits.scala 112:45]
    .clock(pipes_3_clock),
    .reset(pipes_3_reset),
  ...
  AecFp64PipeUnit pipes_4 ( // @[AecFpWarpUnits.scala 112:45]
    .clock(pipes_4_clock),
    .reset(pipes_4_reset),
  ...
  AecFp64PipeUnit pipes_5 ( // @[AecFpWarpUnits.scala 112:45]
    .clock(pipes_5_clock),
    .reset(pipes_5_reset),
  ...
  AecFp64PipeUnit pipes_6 ( // @[AecFpWarpUnits.scala 112:45]
    .clock(pipes_6_clock),
    .reset(pipes_6_reset),
  ...
  AecFp64PipeUnit pipes_7 ( // @[AecFpWarpUnits.scala 112:45]
    .clock(pipes_7_clock),
    .reset(pipes_7_reset),
  ...
  AecFpWarpRequestStage requestStages_0 ( // @[AecFpWarpUnits.scala 114:53]
  ...
  AecFpWarpRequestStage requestStages_1 ( // @[AecFpWarpUnits.scala 114:53]
  ...
  AecFpWarpRequestStage requestStages_2 ( // @[AecFpWarpUnits.scala 114:53]
    ...
    .io_data_2_op(requestStages_2_io_data_2_op),
    .io_data_2_dtype(requestStages_2_io_data_2_dtype),
    .io_data_2_a(requestStages_2_io_data_2_a),
    .io_data_2_b(requestStages_2_io_data_2_b),
    .io_data_2_c(requestStages_2_io_data_2_c),
    .io_data_3_op(requestStages_2_io_data_3_op),
    .io_data_3_dtype(requestStages_2_io_data_3_dtype),
    .io_data_3_a(requestStages_2_io_data_3_a),
    .io_data_3_b(requestStages_2_io_data_3_b),
    .io_data_3_c(requestStages_2_io_data_3_c),
  ...
  AecFpWarpRequestStage requestStages_3 ( // @[AecFpWarpUnits.scala 114:53]
    ...
    .io_data_2_op(requestStages_3_io_data_2_op),
    .io_data_2_dtype(requestStages_3_io_data_2_dtype),
    .io_data_2_a(requestStages_3_io_data_2_a),
    .io_data_2_b(requestStages_3_io_data_2_b),
    .io_data_2_c(requestStages_3_io_data_2_c),
    .io_data_3_op(requestStages_3_io_data_3_op),
    .io_data_3_dtype(requestStages_3_io_data_3_dtype),
    .io_data_3_a(requestStages_3_io_data_3_a),
    .io_data_3_b(requestStages_3_io_data_3_b),
    .io_data_3_c(requestStages_3_io_data_3_c),
  ...
  AecFpWarpRequestStage requestStages_4 ( // @[AecFpWarpUnits.scala 114:53]
    ...
    .io_data_2_op(requestStages_4_io_data_2_op),
    .io_data_2_dtype(requestStages_4_io_data_2_dtype),
    .io_data_2_a(requestStages_4_io_data_2_a),
    .io_data_2_b(requestStages_4_io_data_2_b),
    .io_data_2_c(requestStages_4_io_data_2_c),
    .io_data_3_op(requestStages_4_io_data_3_op),
    .io_data_3_dtype(requestStages_4_io_data_3_dtype),
    .io_data_3_a(requestStages_4_io_data_3_a),
    .io_data_3_b(requestStages_4_io_data_3_b),
    .io_data_3_c(requestStages_4_io_data_3_c),
  ...
  AecFpWarpRequestStage requestStages_5 ( // @[AecFpWarpUnits.scala 114:53]
    ...
    .io_data_2_op(requestStages_5_io_data_2_op),
    .io_data_2_dtype(requestStages_5_io_data_2_dtype),
    .io_data_2_a(requestStages_5_io_data_2_a),
    .io_data_2_b(requestStages_5_io_data_2_b),
    .io_data_2_c(requestStages_5_io_data_2_c),
    .io_data_3_op(requestStages_5_io_data_3_op),
    .io_data_3_dtype(requestStages_5_io_data_3_dtype),
    .io_data_3_a(requestStages_5_io_data_3_a),
    .io_data_3_b(requestStages_5_io_data_3_b),
    .io_data_3_c(requestStages_5_io_data_3_c),
  ...
  AecFpWarpRequestStage requestStages_6 ( // @[AecFpWarpUnits.scala 114:53]
    ...
    .io_data_2_op(requestStages_6_io_data_2_op),
    .io_data_2_dtype(requestStages_6_io_data_2_dtype),
    .io_data_2_a(requestStages_6_io_data_2_a),
    .io_data_2_b(requestStages_6_io_data_2_b),
    .io_data_2_c(requestStages_6_io_data_2_c),
    .io_data_3_op(requestStages_6_io_data_3_op),
    .io_data_3_dtype(requestStages_6_io_data_3_dtype),
    .io_data_3_a(requestStages_6_io_data_3_a),
    .io_data_3_b(requestStages_6_io_data_3_b),
    .io_data_3_c(requestStages_6_io_data_3_c),
  ...
  AecFpWarpRequestStage requestStages_7 ( // @[AecFpWarpUnits.scala 114:53]
    ...
    .io_data_2_op(requestStages_7_io_data_2_op),
    .io_data_2_dtype(requestStages_7_io_data_2_dtype),
    .io_data_2_a(requestStages_7_io_data_2_a),
    .io_data_2_b(requestStages_7_io_data_2_b),
    .io_data_2_c(requestStages_7_io_data_2_c),
    .io_data_3_op(requestStages_7_io_data_3_op),
    .io_data_3_dtype(requestStages_7_io_data_3_dtype),
    .io_data_3_a(requestStages_7_io_data_3_a),
    .io_data_3_b(requestStages_7_io_data_3_b),
    .io_data_3_c(requestStages_7_io_data_3_c),
  ...
  AecWarpRequestBuffer requestBuffer ( // @[AecFpWarpUnits.scala 116:64]
  ...
  AecResultLaneBank resultBanks_0 ( // @[AecFpWarpUnits.scala 128:40]
  ...
  AecResultLaneBank resultBanks_1 ( // @[AecFpWarpUnits.scala 128:40]
  ...
  AecResultLaneBank resultBanks_2 ( // @[AecFpWarpUnits.scala 128:40]
  ...
  AecResultLaneBank resultBanks_3 ( // @[AecFpWarpUnits.scala 128:40]
  ...
  AecResultLaneBank resultBanks_4 ( // @[AecFpWarpUnits.scala 128:40]
  ...
  AecResultLaneBank resultBanks_5 ( // @[AecFpWarpUnits.scala 128:40]
  ...
  AecResultLaneBank resultBanks_6 ( // @[AecFpWarpUnits.scala 128:40]
  ...
  AecResultLaneBank resultBanks_7 ( // @[AecFpWarpUnits.scala 128:40]
  ...
  AecResultLaneBank resultBanks_8 ( // @[AecFpWarpUnits.scala 128:40]
  ...
  AecResultLaneBank resultBanks_9 ( // @[AecFpWarpUnits.scala 128:40]
  ...
  AecResultLaneBank resultBanks_10 ( // @[AecFpWarpUnits.scala 128:40]
  ...
  AecResultLaneBank resultBanks_11 ( // @[AecFpWarpUnits.scala 128:40]
  ...
  AecResultLaneBank resultBanks_12 ( // @[AecFpWarpUnits.scala 128:40]
  ...
  AecResultLaneBank resultBanks_13 ( // @[AecFpWarpUnits.scala 128:40]
  ...
  AecResultLaneBank resultBanks_14 ( // @[AecFpWarpUnits.scala 128:40]
  ...
  AecResultLaneBank resultBanks_15 ( // @[AecFpWarpUnits.scala 128:40]
  ...
  AecResultLaneBank resultBanks_16 ( // @[AecFpWarpUnits.scala 128:40]
  ...
  AecResultLaneBank resultBanks_17 ( // @[AecFpWarpUnits.scala 128:40]
  ...
  AecResultLaneBank resultBanks_18 ( // @[AecFpWarpUnits.scala 128:40]
  ...
  AecResultLaneBank resultBanks_19 ( // @[AecFpWarpUnits.scala 128:40]
  ...
  AecResultLaneBank resultBanks_20 ( // @[AecFpWarpUnits.scala 128:40]
  ...
  AecResultLaneBank resultBanks_21 ( // @[AecFpWarpUnits.scala 128:40]
  ...
  AecResultLaneBank resultBanks_22 ( // @[AecFpWarpUnits.scala 128:40]
  ...
  AecResultLaneBank resultBanks_23 ( // @[AecFpWarpUnits.scala 128:40]
  ...
  AecResultLaneBank resultBanks_24 ( // @[AecFpWarpUnits.scala 128:40]
  ...
  AecResultLaneBank resultBanks_25 ( // @[AecFpWarpUnits.scala 128:40]
  ...
  AecResultLaneBank resultBanks_26 ( // @[AecFpWarpUnits.scala 128:40]
  ...
  AecResultLaneBank resultBanks_27 ( // @[AecFpWarpUnits.scala 128:40]
  ...
  AecResultLaneBank resultBanks_28 ( // @[AecFpWarpUnits.scala 128:40]
  ...
  AecResultLaneBank resultBanks_29 ( // @[AecFpWarpUnits.scala 128:40]
  ...
  AecResultLaneBank resultBanks_30 ( // @[AecFpWarpUnits.scala 128:40]
  ...
  AecResultLaneBank resultBanks_31 ( // @[AecFpWarpUnits.scala 128:40]
  ...
  assign io_resp_bits_result_0 = resultBanks_0_io_result; // @[AecFpWarpUnits.scala 142:{33,33}]
  assign io_resp_bits_result_1 = resultBanks_1_io_result; // @[AecFpWarpUnits.scala 142:{33,33}]
  assign io_resp_bits_result_2 = resultBanks_2_io_result; // @[AecFpWarpUnits.scala 142:{33,33}]
  assign io_resp_bits_result_3 = resultBanks_3_io_result; // @[AecFpWarpUnits.scala 142:{33,33}]
  assign io_resp_bits_result_4 = resultBanks_4_io_result; // @[AecFpWarpUnits.scala 142:{33,33}]
  assign io_resp_bits_result_5 = resultBanks_5_io_result; // @[AecFpWarpUnits.scala 142:{33,33}]
  assign io_resp_bits_result_6 = resultBanks_6_io_result; // @[AecFpWarpUnits.scala 142:{33,33}]
  assign io_resp_bits_result_7 = resultBanks_7_io_result; // @[AecFpWarpUnits.scala 142:{33,33}]
  assign io_resp_bits_result_8 = resultBanks_8_io_result; // @[AecFpWarpUnits.scala 142:{33,33}]
  assign io_resp_bits_result_9 = resultBanks_9_io_result; // @[AecFpWarpUnits.scala 142:{33,33}]
  assign io_resp_bits_result_10 = resultBanks_10_io_result; // @[AecFpWarpUnits.scala 142:{33,33}]
  assign io_resp_bits_result_11 = resultBanks_11_io_result; // @[AecFpWarpUnits.scala 142:{33,33}]
  assign io_resp_bits_result_12 = resultBanks_12_io_result; // @[AecFpWarpUnits.scala 142:{33,33}]
  assign io_resp_bits_result_13 = resultBanks_13_io_result; // @[AecFpWarpUnits.scala 142:{33,33}]
  assign io_resp_bits_result_14 = resultBanks_14_io_result; // @[AecFpWarpUnits.scala 142:{33,33}]
  assign io_resp_bits_result_15 = resultBanks_15_io_result; // @[AecFpWarpUnits.scala 142:{33,33}]
  assign io_resp_bits_result_16 = resultBanks_16_io_result; // @[AecFpWarpUnits.scala 142:{33,33}]
  assign io_resp_bits_result_17 = resultBanks_17_io_result; // @[AecFpWarpUnits.scala 142:{33,33}]
  assign io_resp_bits_result_18 = resultBanks_18_io_result; // @[AecFpWarpUnits.scala 142:{33,33}]
  assign io_resp_bits_result_19 = resultBanks_19_io_result; // @[AecFpWarpUnits.scala 142:{33,33}]
  assign io_resp_bits_result_20 = resultBanks_20_io_result; // @[AecFpWarpUnits.scala 142:{33,33}]
  assign io_resp_bits_result_21 = resultBanks_21_io_result; // @[AecFpWarpUnits.scala 142:{33,33}]
  assign io_resp_bits_result_22 = resultBanks_22_io_result; // @[AecFpWarpUnits.scala 142:{33,33}]
  assign io_resp_bits_result_23 = resultBanks_23_io_result; // @[AecFpWarpUnits.scala 142:{33,33}]
  assign io_resp_bits_result_24 = resultBanks_24_io_result; // @[AecFpWarpUnits.scala 142:{33,33}]
  assign io_resp_bits_result_25 = resultBanks_25_io_result; // @[AecFpWarpUnits.scala 142:{33,33}]
  assign io_resp_bits_result_26 = resultBanks_26_io_result; // @[AecFpWarpUnits.scala 142:{33,33}]
  assign io_resp_bits_result_27 = resultBanks_27_io_result; // @[AecFpWarpUnits.scala 142:{33,33}]
  assign io_resp_bits_result_28 = resultBanks_28_io_result; // @[AecFpWarpUnits.scala 142:{33,33}]
  assign io_resp_bits_result_29 = resultBanks_29_io_result; // @[AecFpWarpUnits.scala 142:{33,33}]
  assign io_resp_bits_result_30 = resultBanks_30_io_result; // @[AecFpWarpUnits.scala 142:{33,33}]
  assign io_resp_bits_result_31 = resultBanks_31_io_result; // @[AecFpWarpUnits.scala 142:{33,33}]
  assign io_resp_bits_predicateMask = {io_resp_bits_predicateMask_hi,io_resp_bits_predicateMask_lo}; // @[AecFpWarpUnits.scala 143:74]
  assign io_resp_bits_errorMask = {io_resp_bits_errorMask_hi,io_resp_bits_errorMask_lo}; // @[AecFpWarpUnits.scala 144:66]
  assign io_resp_bits_exceptionFlags_0 = resultBanks_0_io_flags; // @[AecFpWarpUnits.scala 145:{41,41}]
  assign io_resp_bits_exceptionFlags_1 = resultBanks_1_io_flags; // @[AecFpWarpUnits.scala 145:{41,41}]
  assign io_resp_bits_exceptionFlags_2 = resultBanks_2_io_flags; // @[AecFpWarpUnits.scala 145:{41,41}]
  assign io_resp_bits_exceptionFlags_3 = resultBanks_3_io_flags; // @[AecFpWarpUnits.scala 145:{41,41}]
  assign io_resp_bits_exceptionFlags_4 = resultBanks_4_io_flags; // @[AecFpWarpUnits.scala 145:{41,41}]
  assign io_resp_bits_exceptionFlags_5 = resultBanks_5_io_flags; // @[AecFpWarpUnits.scala 145:{41,41}]
  assign io_resp_bits_exceptionFlags_6 = resultBanks_6_io_flags; // @[AecFpWarpUnits.scala 145:{41,41}]
  assign io_resp_bits_exceptionFlags_7 = resultBanks_7_io_flags; // @[AecFpWarpUnits.scala 145:{41,41}]
  assign io_resp_bits_exceptionFlags_8 = resultBanks_8_io_flags; // @[AecFpWarpUnits.scala 145:{41,41}]
  assign io_resp_bits_exceptionFlags_9 = resultBanks_9_io_flags; // @[AecFpWarpUnits.scala 145:{41,41}]
  assign io_resp_bits_exceptionFlags_10 = resultBanks_10_io_flags; // @[AecFpWarpUnits.scala 145:{41,41}]
  assign io_resp_bits_exceptionFlags_11 = resultBanks_11_io_flags; // @[AecFpWarpUnits.scala 145:{41,41}]
  assign io_resp_bits_exceptionFlags_12 = resultBanks_12_io_flags; // @[AecFpWarpUnits.scala 145:{41,41}]
  assign io_resp_bits_exceptionFlags_13 = resultBanks_13_io_flags; // @[AecFpWarpUnits.scala 145:{41,41}]
  assign io_resp_bits_exceptionFlags_14 = resultBanks_14_io_flags; // @[AecFpWarpUnits.scala 145:{41,41}]
  assign io_resp_bits_exceptionFlags_15 = resultBanks_15_io_flags; // @[AecFpWarpUnits.scala 145:{41,41}]
  assign io_resp_bits_exceptionFlags_16 = resultBanks_16_io_flags; // @[AecFpWarpUnits.scala 145:{41,41}]
  assign io_resp_bits_exceptionFlags_17 = resultBanks_17_io_flags; // @[AecFpWarpUnits.scala 145:{41,41}]
  assign io_resp_bits_exceptionFlags_18 = resultBanks_18_io_flags; // @[AecFpWarpUnits.scala 145:{41,41}]
  assign io_resp_bits_exceptionFlags_19 = resultBanks_19_io_flags; // @[AecFpWarpUnits.scala 145:{41,41}]
  assign io_resp_bits_exceptionFlags_20 = resultBanks_20_io_flags; // @[AecFpWarpUnits.scala 145:{41,41}]
  assign io_resp_bits_exceptionFlags_21 = resultBanks_21_io_flags; // @[AecFpWarpUnits.scala 145:{41,41}]
  assign io_resp_bits_exceptionFlags_22 = resultBanks_22_io_flags; // @[AecFpWarpUnits.scala 145:{41,41}]
  assign io_resp_bits_exceptionFlags_23 = resultBanks_23_io_flags; // @[AecFpWarpUnits.scala 145:{41,41}]
  assign io_resp_bits_exceptionFlags_24 = resultBanks_24_io_flags; // @[AecFpWarpUnits.scala 145:{41,41}]
  assign io_resp_bits_exceptionFlags_25 = resultBanks_25_io_flags; // @[AecFpWarpUnits.scala 145:{41,41}]
  assign io_resp_bits_exceptionFlags_26 = resultBanks_26_io_flags; // @[AecFpWarpUnits.scala 145:{41,41}]
  assign io_resp_bits_exceptionFlags_27 = resultBanks_27_io_flags; // @[AecFpWarpUnits.scala 145:{41,41}]
  assign io_resp_bits_exceptionFlags_28 = resultBanks_28_io_flags; // @[AecFpWarpUnits.scala 145:{41,41}]
  assign io_resp_bits_exceptionFlags_29 = resultBanks_29_io_flags; // @[AecFpWarpUnits.scala 145:{41,41}]
  assign io_resp_bits_exceptionFlags_30 = resultBanks_30_io_flags; // @[AecFpWarpUnits.scala 145:{41,41}]
  assign io_resp_bits_exceptionFlags_31 = resultBanks_31_io_flags; // @[AecFpWarpUnits.scala 145:{41,41}]
  assign io_resp_bits_activeMask = requestBuffer_io_out_activeMask; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign io_resp_bits_dest = requestBuffer_io_out_dest; // @[AecFpWarpUnits.scala 115:18 119:10]
  ...
  assign pipes_2_io_req_valid = requestStages_2_io_out_valid; // @[AecFpWarpUnits.scala 159:21]
  assign pipes_2_io_req_bits_op = requestStages_2_io_out_bits_op; // @[AecFpWarpUnits.scala 159:21]
  assign pipes_2_io_req_bits_dtype = requestStages_2_io_out_bits_dtype; // @[AecFpWarpUnits.scala 159:21]
  assign pipes_2_io_req_bits_a = requestStages_2_io_out_bits_a; // @[AecFpWarpUnits.scala 159:21]
  assign pipes_2_io_req_bits_b = requestStages_2_io_out_bits_b; // @[AecFpWarpUnits.scala 159:21]
  assign pipes_2_io_req_bits_c = requestStages_2_io_out_bits_c; // @[AecFpWarpUnits.scala 159:21]
  assign pipes_2_io_resp_ready = _armCapture_T_5 & allValid; // @[AecFpWarpUnits.scala 160:41]
  assign pipes_3_clock = clock;
  assign pipes_3_reset = reset;
  assign pipes_3_io_req_valid = requestStages_3_io_out_valid; // @[AecFpWarpUnits.scala 159:21]
  assign pipes_3_io_req_bits_op = requestStages_3_io_out_bits_op; // @[AecFpWarpUnits.scala 159:21]
  assign pipes_3_io_req_bits_dtype = requestStages_3_io_out_bits_dtype; // @[AecFpWarpUnits.scala 159:21]
  assign pipes_3_io_req_bits_a = requestStages_3_io_out_bits_a; // @[AecFpWarpUnits.scala 159:21]
  assign pipes_3_io_req_bits_b = requestStages_3_io_out_bits_b; // @[AecFpWarpUnits.scala 159:21]
  assign pipes_3_io_req_bits_c = requestStages_3_io_out_bits_c; // @[AecFpWarpUnits.scala 159:21]
  assign pipes_3_io_resp_ready = _armCapture_T_5 & allValid; // @[AecFpWarpUnits.scala 160:41]
  assign pipes_4_clock = clock;
  assign pipes_4_reset = reset;
  assign pipes_4_io_req_valid = requestStages_4_io_out_valid; // @[AecFpWarpUnits.scala 159:21]
  assign pipes_4_io_req_bits_op = requestStages_4_io_out_bits_op; // @[AecFpWarpUnits.scala 159:21]
  assign pipes_4_io_req_bits_dtype = requestStages_4_io_out_bits_dtype; // @[AecFpWarpUnits.scala 159:21]
  assign pipes_4_io_req_bits_a = requestStages_4_io_out_bits_a; // @[AecFpWarpUnits.scala 159:21]
  assign pipes_4_io_req_bits_b = requestStages_4_io_out_bits_b; // @[AecFpWarpUnits.scala 159:21]
  assign pipes_4_io_req_bits_c = requestStages_4_io_out_bits_c; // @[AecFpWarpUnits.scala 159:21]
  assign pipes_4_io_resp_ready = _armCapture_T_5 & allValid; // @[AecFpWarpUnits.scala 160:41]
  assign pipes_5_clock = clock;
  assign pipes_5_reset = reset;
  assign pipes_5_io_req_valid = requestStages_5_io_out_valid; // @[AecFpWarpUnits.scala 159:21]
  assign pipes_5_io_req_bits_op = requestStages_5_io_out_bits_op; // @[AecFpWarpUnits.scala 159:21]
  assign pipes_5_io_req_bits_dtype = requestStages_5_io_out_bits_dtype; // @[AecFpWarpUnits.scala 159:21]
  assign pipes_5_io_req_bits_a = requestStages_5_io_out_bits_a; // @[AecFpWarpUnits.scala 159:21]
  assign pipes_5_io_req_bits_b = requestStages_5_io_out_bits_b; // @[AecFpWarpUnits.scala 159:21]
  assign pipes_5_io_req_bits_c = requestStages_5_io_out_bits_c; // @[AecFpWarpUnits.scala 159:21]
  assign pipes_5_io_resp_ready = _armCapture_T_5 & allValid; // @[AecFpWarpUnits.scala 160:41]
  assign pipes_6_clock = clock;
  assign pipes_6_reset = reset;
  assign pipes_6_io_req_valid = requestStages_6_io_out_valid; // @[AecFpWarpUnits.scala 159:21]
  assign pipes_6_io_req_bits_op = requestStages_6_io_out_bits_op; // @[AecFpWarpUnits.scala 159:21]
  assign pipes_6_io_req_bits_dtype = requestStages_6_io_out_bits_dtype; // @[AecFpWarpUnits.scala 159:21]
  assign pipes_6_io_req_bits_a = requestStages_6_io_out_bits_a; // @[AecFpWarpUnits.scala 159:21]
  assign pipes_6_io_req_bits_b = requestStages_6_io_out_bits_b; // @[AecFpWarpUnits.scala 159:21]
  assign pipes_6_io_req_bits_c = requestStages_6_io_out_bits_c; // @[AecFpWarpUnits.scala 159:21]
  assign pipes_6_io_resp_ready = _armCapture_T_5 & allValid; // @[AecFpWarpUnits.scala 160:41]
  assign pipes_7_clock = clock;
  assign pipes_7_reset = reset;
  assign pipes_7_io_req_valid = requestStages_7_io_out_valid; // @[AecFpWarpUnits.scala 159:21]
  assign pipes_7_io_req_bits_op = requestStages_7_io_out_bits_op; // @[AecFpWarpUnits.scala 159:21]
  assign pipes_7_io_req_bits_dtype = requestStages_7_io_out_bits_dtype; // @[AecFpWarpUnits.scala 159:21]
  assign pipes_7_io_req_bits_a = requestStages_7_io_out_bits_a; // @[AecFpWarpUnits.scala 159:21]
  assign pipes_7_io_req_bits_b = requestStages_7_io_out_bits_b; // @[AecFpWarpUnits.scala 159:21]
  assign pipes_7_io_req_bits_c = requestStages_7_io_out_bits_c; // @[AecFpWarpUnits.scala 159:21]
  assign pipes_7_io_resp_ready = _armCapture_T_5 & allValid; // @[AecFpWarpUnits.scala 160:41]
  assign requestStages_0_clock = clock;
  assign requestStages_0_reset = reset;
  assign requestStages_0_io_inValid = running & ~groupIssued & _armCapture_T_5 & allReady; // @[AecFpWarpUnits.scala 148:93]
  assign requestStages_0_io_group = group; // @[AecFpWarpUnits.scala 149:31]
  assign requestStages_0_io_data_0_op = held_op[6:0]; // @[AecFpWarpUnits.scala 152:48]
  assign requestStages_0_io_data_0_dtype = requestBuffer_io_out_dtype; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_0_io_data_0_a = requestBuffer_io_out_a_0; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_0_io_data_0_b = requestBuffer_io_out_b_0; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_0_io_data_0_c = requestBuffer_io_out_c_0; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_0_io_data_1_op = held_op[6:0]; // @[AecFpWarpUnits.scala 152:48]
  assign requestStages_0_io_data_1_dtype = requestBuffer_io_out_dtype; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_0_io_data_1_a = requestBuffer_io_out_a_8; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_0_io_data_1_b = requestBuffer_io_out_b_8; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_0_io_data_1_c = requestBuffer_io_out_c_8; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_0_io_data_2_op = held_op[6:0]; // @[AecFpWarpUnits.scala 152:48]
  assign requestStages_0_io_data_2_dtype = requestBuffer_io_out_dtype; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_0_io_data_2_a = requestBuffer_io_out_a_16; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_0_io_data_2_b = requestBuffer_io_out_b_16; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_0_io_data_2_c = requestBuffer_io_out_c_16; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_0_io_data_3_op = held_op[6:0]; // @[AecFpWarpUnits.scala 152:48]
  assign requestStages_0_io_data_3_dtype = requestBuffer_io_out_dtype; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_0_io_data_3_a = requestBuffer_io_out_a_24; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_0_io_data_3_b = requestBuffer_io_out_b_24; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_0_io_data_3_c = requestBuffer_io_out_c_24; // @[AecFpWarpUnits.scala 115:18 119:10]
  ...
  assign requestStages_1_io_inValid = running & ~groupIssued & _armCapture_T_5 & allReady; // @[AecFpWarpUnits.scala 148:93]
  assign requestStages_1_io_group = group; // @[AecFpWarpUnits.scala 149:31]
  assign requestStages_1_io_data_0_op = held_op[6:0]; // @[AecFpWarpUnits.scala 152:48]
  assign requestStages_1_io_data_0_dtype = requestBuffer_io_out_dtype; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_1_io_data_0_a = requestBuffer_io_out_a_1; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_1_io_data_0_b = requestBuffer_io_out_b_1; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_1_io_data_0_c = requestBuffer_io_out_c_1; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_1_io_data_1_op = held_op[6:0]; // @[AecFpWarpUnits.scala 152:48]
  assign requestStages_1_io_data_1_dtype = requestBuffer_io_out_dtype; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_1_io_data_1_a = requestBuffer_io_out_a_9; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_1_io_data_1_b = requestBuffer_io_out_b_9; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_1_io_data_1_c = requestBuffer_io_out_c_9; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_1_io_data_2_op = held_op[6:0]; // @[AecFpWarpUnits.scala 152:48]
  assign requestStages_1_io_data_2_dtype = requestBuffer_io_out_dtype; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_1_io_data_2_a = requestBuffer_io_out_a_17; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_1_io_data_2_b = requestBuffer_io_out_b_17; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_1_io_data_2_c = requestBuffer_io_out_c_17; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_1_io_data_3_op = held_op[6:0]; // @[AecFpWarpUnits.scala 152:48]
  assign requestStages_1_io_data_3_dtype = requestBuffer_io_out_dtype; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_1_io_data_3_a = requestBuffer_io_out_a_25; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_1_io_data_3_b = requestBuffer_io_out_b_25; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_1_io_data_3_c = requestBuffer_io_out_c_25; // @[AecFpWarpUnits.scala 115:18 119:10]
  ...
  assign requestStages_2_io_inValid = running & ~groupIssued & _armCapture_T_5 & allReady; // @[AecFpWarpUnits.scala 148:93]
  assign requestStages_2_io_group = group; // @[AecFpWarpUnits.scala 149:31]
  assign requestStages_2_io_data_0_op = held_op[6:0]; // @[AecFpWarpUnits.scala 152:48]
  assign requestStages_2_io_data_0_dtype = requestBuffer_io_out_dtype; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_2_io_data_0_a = requestBuffer_io_out_a_2; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_2_io_data_0_b = requestBuffer_io_out_b_2; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_2_io_data_0_c = requestBuffer_io_out_c_2; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_2_io_data_1_op = held_op[6:0]; // @[AecFpWarpUnits.scala 152:48]
  assign requestStages_2_io_data_1_dtype = requestBuffer_io_out_dtype; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_2_io_data_1_a = requestBuffer_io_out_a_10; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_2_io_data_1_b = requestBuffer_io_out_b_10; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_2_io_data_1_c = requestBuffer_io_out_c_10; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_2_io_data_2_op = held_op[6:0]; // @[AecFpWarpUnits.scala 152:48]
  assign requestStages_2_io_data_2_dtype = requestBuffer_io_out_dtype; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_2_io_data_2_a = requestBuffer_io_out_a_18; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_2_io_data_2_b = requestBuffer_io_out_b_18; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_2_io_data_2_c = requestBuffer_io_out_c_18; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_2_io_data_3_op = held_op[6:0]; // @[AecFpWarpUnits.scala 152:48]
  assign requestStages_2_io_data_3_dtype = requestBuffer_io_out_dtype; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_2_io_data_3_a = requestBuffer_io_out_a_26; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_2_io_data_3_b = requestBuffer_io_out_b_26; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_2_io_data_3_c = requestBuffer_io_out_c_26; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_2_io_out_ready = pipes_2_io_req_ready; // @[AecFpWarpUnits.scala 159:21]
  assign requestStages_3_clock = clock;
  assign requestStages_3_reset = reset;
  assign requestStages_3_io_inValid = running & ~groupIssued & _armCapture_T_5 & allReady; // @[AecFpWarpUnits.scala 148:93]
  assign requestStages_3_io_group = group; // @[AecFpWarpUnits.scala 149:31]
  assign requestStages_3_io_data_0_op = held_op[6:0]; // @[AecFpWarpUnits.scala 152:48]
  assign requestStages_3_io_data_0_dtype = requestBuffer_io_out_dtype; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_3_io_data_0_a = requestBuffer_io_out_a_3; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_3_io_data_0_b = requestBuffer_io_out_b_3; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_3_io_data_0_c = requestBuffer_io_out_c_3; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_3_io_data_1_op = held_op[6:0]; // @[AecFpWarpUnits.scala 152:48]
  assign requestStages_3_io_data_1_dtype = requestBuffer_io_out_dtype; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_3_io_data_1_a = requestBuffer_io_out_a_11; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_3_io_data_1_b = requestBuffer_io_out_b_11; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_3_io_data_1_c = requestBuffer_io_out_c_11; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_3_io_data_2_op = held_op[6:0]; // @[AecFpWarpUnits.scala 152:48]
  assign requestStages_3_io_data_2_dtype = requestBuffer_io_out_dtype; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_3_io_data_2_a = requestBuffer_io_out_a_19; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_3_io_data_2_b = requestBuffer_io_out_b_19; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_3_io_data_2_c = requestBuffer_io_out_c_19; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_3_io_data_3_op = held_op[6:0]; // @[AecFpWarpUnits.scala 152:48]
  assign requestStages_3_io_data_3_dtype = requestBuffer_io_out_dtype; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_3_io_data_3_a = requestBuffer_io_out_a_27; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_3_io_data_3_b = requestBuffer_io_out_b_27; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_3_io_data_3_c = requestBuffer_io_out_c_27; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_3_io_out_ready = pipes_3_io_req_ready; // @[AecFpWarpUnits.scala 159:21]
  assign requestStages_4_clock = clock;
  assign requestStages_4_reset = reset;
  assign requestStages_4_io_inValid = running & ~groupIssued & _armCapture_T_5 & allReady; // @[AecFpWarpUnits.scala 148:93]
  assign requestStages_4_io_group = group; // @[AecFpWarpUnits.scala 149:31]
  assign requestStages_4_io_data_0_op = held_op[6:0]; // @[AecFpWarpUnits.scala 152:48]
  assign requestStages_4_io_data_0_dtype = requestBuffer_io_out_dtype; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_4_io_data_0_a = requestBuffer_io_out_a_4; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_4_io_data_0_b = requestBuffer_io_out_b_4; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_4_io_data_0_c = requestBuffer_io_out_c_4; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_4_io_data_1_op = held_op[6:0]; // @[AecFpWarpUnits.scala 152:48]
  assign requestStages_4_io_data_1_dtype = requestBuffer_io_out_dtype; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_4_io_data_1_a = requestBuffer_io_out_a_12; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_4_io_data_1_b = requestBuffer_io_out_b_12; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_4_io_data_1_c = requestBuffer_io_out_c_12; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_4_io_data_2_op = held_op[6:0]; // @[AecFpWarpUnits.scala 152:48]
  assign requestStages_4_io_data_2_dtype = requestBuffer_io_out_dtype; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_4_io_data_2_a = requestBuffer_io_out_a_20; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_4_io_data_2_b = requestBuffer_io_out_b_20; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_4_io_data_2_c = requestBuffer_io_out_c_20; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_4_io_data_3_op = held_op[6:0]; // @[AecFpWarpUnits.scala 152:48]
  assign requestStages_4_io_data_3_dtype = requestBuffer_io_out_dtype; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_4_io_data_3_a = requestBuffer_io_out_a_28; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_4_io_data_3_b = requestBuffer_io_out_b_28; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_4_io_data_3_c = requestBuffer_io_out_c_28; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_4_io_out_ready = pipes_4_io_req_ready; // @[AecFpWarpUnits.scala 159:21]
  assign requestStages_5_clock = clock;
  assign requestStages_5_reset = reset;
  assign requestStages_5_io_inValid = running & ~groupIssued & _armCapture_T_5 & allReady; // @[AecFpWarpUnits.scala 148:93]
  assign requestStages_5_io_group = group; // @[AecFpWarpUnits.scala 149:31]
  assign requestStages_5_io_data_0_op = held_op[6:0]; // @[AecFpWarpUnits.scala 152:48]
  assign requestStages_5_io_data_0_dtype = requestBuffer_io_out_dtype; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_5_io_data_0_a = requestBuffer_io_out_a_5; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_5_io_data_0_b = requestBuffer_io_out_b_5; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_5_io_data_0_c = requestBuffer_io_out_c_5; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_5_io_data_1_op = held_op[6:0]; // @[AecFpWarpUnits.scala 152:48]
  assign requestStages_5_io_data_1_dtype = requestBuffer_io_out_dtype; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_5_io_data_1_a = requestBuffer_io_out_a_13; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_5_io_data_1_b = requestBuffer_io_out_b_13; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_5_io_data_1_c = requestBuffer_io_out_c_13; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_5_io_data_2_op = held_op[6:0]; // @[AecFpWarpUnits.scala 152:48]
  assign requestStages_5_io_data_2_dtype = requestBuffer_io_out_dtype; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_5_io_data_2_a = requestBuffer_io_out_a_21; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_5_io_data_2_b = requestBuffer_io_out_b_21; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_5_io_data_2_c = requestBuffer_io_out_c_21; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_5_io_data_3_op = held_op[6:0]; // @[AecFpWarpUnits.scala 152:48]
  assign requestStages_5_io_data_3_dtype = requestBuffer_io_out_dtype; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_5_io_data_3_a = requestBuffer_io_out_a_29; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_5_io_data_3_b = requestBuffer_io_out_b_29; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_5_io_data_3_c = requestBuffer_io_out_c_29; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_5_io_out_ready = pipes_5_io_req_ready; // @[AecFpWarpUnits.scala 159:21]
  assign requestStages_6_clock = clock;
  assign requestStages_6_reset = reset;
  assign requestStages_6_io_inValid = running & ~groupIssued & _armCapture_T_5 & allReady; // @[AecFpWarpUnits.scala 148:93]
  assign requestStages_6_io_group = group; // @[AecFpWarpUnits.scala 149:31]
  assign requestStages_6_io_data_0_op = held_op[6:0]; // @[AecFpWarpUnits.scala 152:48]
  assign requestStages_6_io_data_0_dtype = requestBuffer_io_out_dtype; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_6_io_data_0_a = requestBuffer_io_out_a_6; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_6_io_data_0_b = requestBuffer_io_out_b_6; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_6_io_data_0_c = requestBuffer_io_out_c_6; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_6_io_data_1_op = held_op[6:0]; // @[AecFpWarpUnits.scala 152:48]
  assign requestStages_6_io_data_1_dtype = requestBuffer_io_out_dtype; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_6_io_data_1_a = requestBuffer_io_out_a_14; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_6_io_data_1_b = requestBuffer_io_out_b_14; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_6_io_data_1_c = requestBuffer_io_out_c_14; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_6_io_data_2_op = held_op[6:0]; // @[AecFpWarpUnits.scala 152:48]
  assign requestStages_6_io_data_2_dtype = requestBuffer_io_out_dtype; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_6_io_data_2_a = requestBuffer_io_out_a_22; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_6_io_data_2_b = requestBuffer_io_out_b_22; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_6_io_data_2_c = requestBuffer_io_out_c_22; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_6_io_data_3_op = held_op[6:0]; // @[AecFpWarpUnits.scala 152:48]
  assign requestStages_6_io_data_3_dtype = requestBuffer_io_out_dtype; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_6_io_data_3_a = requestBuffer_io_out_a_30; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_6_io_data_3_b = requestBuffer_io_out_b_30; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_6_io_data_3_c = requestBuffer_io_out_c_30; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_6_io_out_ready = pipes_6_io_req_ready; // @[AecFpWarpUnits.scala 159:21]
  assign requestStages_7_clock = clock;
  assign requestStages_7_reset = reset;
  assign requestStages_7_io_inValid = running & ~groupIssued & _armCapture_T_5 & allReady; // @[AecFpWarpUnits.scala 148:93]
  assign requestStages_7_io_group = group; // @[AecFpWarpUnits.scala 149:31]
  assign requestStages_7_io_data_0_op = held_op[6:0]; // @[AecFpWarpUnits.scala 152:48]
  assign requestStages_7_io_data_0_dtype = requestBuffer_io_out_dtype; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_7_io_data_0_a = requestBuffer_io_out_a_7; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_7_io_data_0_b = requestBuffer_io_out_b_7; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_7_io_data_0_c = requestBuffer_io_out_c_7; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_7_io_data_1_op = held_op[6:0]; // @[AecFpWarpUnits.scala 152:48]
  assign requestStages_7_io_data_1_dtype = requestBuffer_io_out_dtype; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_7_io_data_1_a = requestBuffer_io_out_a_15; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_7_io_data_1_b = requestBuffer_io_out_b_15; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_7_io_data_1_c = requestBuffer_io_out_c_15; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_7_io_data_2_op = held_op[6:0]; // @[AecFpWarpUnits.scala 152:48]
  assign requestStages_7_io_data_2_dtype = requestBuffer_io_out_dtype; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_7_io_data_2_a = requestBuffer_io_out_a_23; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_7_io_data_2_b = requestBuffer_io_out_b_23; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_7_io_data_2_c = requestBuffer_io_out_c_23; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_7_io_data_3_op = held_op[6:0]; // @[AecFpWarpUnits.scala 152:48]
  assign requestStages_7_io_data_3_dtype = requestBuffer_io_out_dtype; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_7_io_data_3_a = requestBuffer_io_out_a_31; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_7_io_data_3_b = requestBuffer_io_out_b_31; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_7_io_data_3_c = requestBuffer_io_out_c_31; // @[AecFpWarpUnits.scala 115:18 119:10]
  assign requestStages_7_io_out_ready = pipes_7_io_req_ready; // @[AecFpWarpUnits.scala 159:21]
  assign requestBuffer_clock = clock;
  assign requestBuffer_reset = reset;
  assign requestBuffer_io_in_op = io_req_bits_op; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_dtype = io_req_bits_dtype; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_activeMask = io_req_bits_activeMask; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_a_0 = io_req_bits_a_0; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_a_1 = io_req_bits_a_1; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_a_2 = io_req_bits_a_2; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_a_3 = io_req_bits_a_3; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_a_4 = io_req_bits_a_4; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_a_5 = io_req_bits_a_5; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_a_6 = io_req_bits_a_6; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_a_7 = io_req_bits_a_7; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_a_8 = io_req_bits_a_8; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_a_9 = io_req_bits_a_9; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_a_10 = io_req_bits_a_10; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_a_11 = io_req_bits_a_11; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_a_12 = io_req_bits_a_12; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_a_13 = io_req_bits_a_13; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_a_14 = io_req_bits_a_14; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_a_15 = io_req_bits_a_15; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_a_16 = io_req_bits_a_16; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_a_17 = io_req_bits_a_17; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_a_18 = io_req_bits_a_18; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_a_19 = io_req_bits_a_19; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_a_20 = io_req_bits_a_20; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_a_21 = io_req_bits_a_21; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_a_22 = io_req_bits_a_22; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_a_23 = io_req_bits_a_23; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_a_24 = io_req_bits_a_24; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_a_25 = io_req_bits_a_25; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_a_26 = io_req_bits_a_26; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_a_27 = io_req_bits_a_27; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_a_28 = io_req_bits_a_28; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_a_29 = io_req_bits_a_29; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_a_30 = io_req_bits_a_30; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_a_31 = io_req_bits_a_31; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_b_0 = io_req_bits_b_0; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_b_1 = io_req_bits_b_1; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_b_2 = io_req_bits_b_2; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_b_3 = io_req_bits_b_3; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_b_4 = io_req_bits_b_4; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_b_5 = io_req_bits_b_5; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_b_6 = io_req_bits_b_6; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_b_7 = io_req_bits_b_7; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_b_8 = io_req_bits_b_8; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_b_9 = io_req_bits_b_9; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_b_10 = io_req_bits_b_10; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_b_11 = io_req_bits_b_11; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_b_12 = io_req_bits_b_12; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_b_13 = io_req_bits_b_13; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_b_14 = io_req_bits_b_14; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_b_15 = io_req_bits_b_15; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_b_16 = io_req_bits_b_16; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_b_17 = io_req_bits_b_17; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_b_18 = io_req_bits_b_18; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_b_19 = io_req_bits_b_19; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_b_20 = io_req_bits_b_20; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_b_21 = io_req_bits_b_21; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_b_22 = io_req_bits_b_22; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_b_23 = io_req_bits_b_23; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_b_24 = io_req_bits_b_24; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_b_25 = io_req_bits_b_25; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_b_26 = io_req_bits_b_26; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_b_27 = io_req_bits_b_27; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_b_28 = io_req_bits_b_28; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_b_29 = io_req_bits_b_29; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_b_30 = io_req_bits_b_30; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_b_31 = io_req_bits_b_31; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_c_0 = io_req_bits_c_0; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_c_1 = io_req_bits_c_1; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_c_2 = io_req_bits_c_2; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_c_3 = io_req_bits_c_3; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_c_4 = io_req_bits_c_4; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_c_5 = io_req_bits_c_5; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_c_6 = io_req_bits_c_6; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_c_7 = io_req_bits_c_7; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_c_8 = io_req_bits_c_8; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_c_9 = io_req_bits_c_9; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_c_10 = io_req_bits_c_10; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_c_11 = io_req_bits_c_11; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_c_12 = io_req_bits_c_12; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_c_13 = io_req_bits_c_13; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_c_14 = io_req_bits_c_14; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_c_15 = io_req_bits_c_15; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_c_16 = io_req_bits_c_16; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_c_17 = io_req_bits_c_17; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_c_18 = io_req_bits_c_18; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_c_19 = io_req_bits_c_19; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_c_20 = io_req_bits_c_20; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_c_21 = io_req_bits_c_21; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_c_22 = io_req_bits_c_22; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_c_23 = io_req_bits_c_23; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_c_24 = io_req_bits_c_24; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_c_25 = io_req_bits_c_25; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_c_26 = io_req_bits_c_26; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_c_27 = io_req_bits_c_27; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_c_28 = io_req_bits_c_28; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_c_29 = io_req_bits_c_29; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_c_30 = io_req_bits_c_30; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_c_31 = io_req_bits_c_31; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_in_dest = io_req_bits_dest; // @[AecFpWarpUnits.scala 118:29]
  assign requestBuffer_io_arm_0 = armClusters_0; // @[AecFpWarpUnits.scala 137:30]
  assign requestBuffer_io_arm_1 = armClusters_1; // @[AecFpWarpUnits.scala 137:30]
  assign requestBuffer_io_arm_2 = armClusters_2; // @[AecFpWarpUnits.scala 137:30]
  assign requestBuffer_io_arm_3 = armClusters_3; // @[AecFpWarpUnits.scala 137:30]
  assign requestBuffer_io_arm_4 = armClusters_4; // @[AecFpWarpUnits.scala 137:30]
  assign requestBuffer_io_arm_5 = armClusters_5; // @[AecFpWarpUnits.scala 137:30]
  assign requestBuffer_io_arm_6 = armClusters_6; // @[AecFpWarpUnits.scala 137:30]
  assign requestBuffer_io_arm_7 = armClusters_7; // @[AecFpWarpUnits.scala 137:30]
  ...
  assign resultBanks_0_io_write = running & _armCapture_T_5 & allValid & group == 2'h0; // @[AecFpWarpUnits.scala 164:81]
  assign resultBanks_0_io_writeResult = held_activeMask[0] ? pipes_0_io_resp_bits_result : 64'h0; // @[AecFpWarpUnits.scala 165:57]
  assign resultBanks_0_io_writeFlags = held_activeMask[0] ? pipes_0_io_resp_bits_exception_flags : 5'h0; // @[AecFpWarpUnits.scala 166:56]
  assign resultBanks_0_io_writePredicate = held_activeMask[0] & pipes_0_io_resp_bits_predicate_result; // @[AecFpWarpUnits.scala 167:92]
  assign resultBanks_0_io_writeError = held_activeMask[0] & pipes_0_io_resp_bits_error; // @[AecFpWarpUnits.scala 168:88]
  assign resultBanks_1_clock = clock;
  assign resultBanks_1_reset = reset;
  assign resultBanks_1_io_write = running & _armCapture_T_5 & allValid & group == 2'h0; // @[AecFpWarpUnits.scala 164:81]
  assign resultBanks_1_io_writeResult = held_activeMask[1] ? pipes_1_io_resp_bits_result : 64'h0; // @[AecFpWarpUnits.scala 165:57]
  assign resultBanks_1_io_writeFlags = held_activeMask[1] ? pipes_1_io_resp_bits_exception_flags : 5'h0; // @[AecFpWarpUnits.scala 166:56]
  assign resultBanks_1_io_writePredicate = held_activeMask[1] & pipes_1_io_resp_bits_predicate_result; // @[AecFpWarpUnits.scala 167:92]
  assign resultBanks_1_io_writeError = held_activeMask[1] & pipes_1_io_resp_bits_error; // @[AecFpWarpUnits.scala 168:88]
  assign resultBanks_2_clock = clock;
  assign resultBanks_2_reset = reset;
  assign resultBanks_2_io_write = running & _armCapture_T_5 & allValid & group == 2'h0; // @[AecFpWarpUnits.scala 164:81]
  assign resultBanks_2_io_writeResult = held_activeMask[2] ? pipes_2_io_resp_bits_result : 64'h0; // @[AecFpWarpUnits.scala 165:57]
  assign resultBanks_2_io_writeFlags = held_activeMask[2] ? pipes_2_io_resp_bits_exception_flags : 5'h0; // @[AecFpWarpUnits.scala 166:56]
  assign resultBanks_2_io_writePredicate = held_activeMask[2] & pipes_2_io_resp_bits_predicate_result; // @[AecFpWarpUnits.scala 167:92]
  assign resultBanks_2_io_writeError = held_activeMask[2] & pipes_2_io_resp_bits_error; // @[AecFpWarpUnits.scala 168:88]
  assign resultBanks_3_clock = clock;
  assign resultBanks_3_reset = reset;
  assign resultBanks_3_io_write = running & _armCapture_T_5 & allValid & group == 2'h0; // @[AecFpWarpUnits.scala 164:81]
  assign resultBanks_3_io_writeResult = held_activeMask[3] ? pipes_3_io_resp_bits_result : 64'h0; // @[AecFpWarpUnits.scala 165:57]
  assign resultBanks_3_io_writeFlags = held_activeMask[3] ? pipes_3_io_resp_bits_exception_flags : 5'h0; // @[AecFpWarpUnits.scala 166:56]
  assign resultBanks_3_io_writePredicate = held_activeMask[3] & pipes_3_io_resp_bits_predicate_result; // @[AecFpWarpUnits.scala 167:92]
  assign resultBanks_3_io_writeError = held_activeMask[3] & pipes_3_io_resp_bits_error; // @[AecFpWarpUnits.scala 168:88]
  assign resultBanks_4_clock = clock;
  assign resultBanks_4_reset = reset;
  assign resultBanks_4_io_write = running & _armCapture_T_5 & allValid & group == 2'h0; // @[AecFpWarpUnits.scala 164:81]
  assign resultBanks_4_io_writeResult = held_activeMask[4] ? pipes_4_io_resp_bits_result : 64'h0; // @[AecFpWarpUnits.scala 165:57]
  assign resultBanks_4_io_writeFlags = held_activeMask[4] ? pipes_4_io_resp_bits_exception_flags : 5'h0; // @[AecFpWarpUnits.scala 166:56]
  assign resultBanks_4_io_writePredicate = held_activeMask[4] & pipes_4_io_resp_bits_predicate_result; // @[AecFpWarpUnits.scala 167:92]
  assign resultBanks_4_io_writeError = held_activeMask[4] & pipes_4_io_resp_bits_error; // @[AecFpWarpUnits.scala 168:88]
  assign resultBanks_5_clock = clock;
  assign resultBanks_5_reset = reset;
  assign resultBanks_5_io_write = running & _armCapture_T_5 & allValid & group == 2'h0; // @[AecFpWarpUnits.scala 164:81]
  assign resultBanks_5_io_writeResult = held_activeMask[5] ? pipes_5_io_resp_bits_result : 64'h0; // @[AecFpWarpUnits.scala 165:57]
  assign resultBanks_5_io_writeFlags = held_activeMask[5] ? pipes_5_io_resp_bits_exception_flags : 5'h0; // @[AecFpWarpUnits.scala 166:56]
  assign resultBanks_5_io_writePredicate = held_activeMask[5] & pipes_5_io_resp_bits_predicate_result; // @[AecFpWarpUnits.scala 167:92]
  assign resultBanks_5_io_writeError = held_activeMask[5] & pipes_5_io_resp_bits_error; // @[AecFpWarpUnits.scala 168:88]
  assign resultBanks_6_clock = clock;
  assign resultBanks_6_reset = reset;
  assign resultBanks_6_io_write = running & _armCapture_T_5 & allValid & group == 2'h0; // @[AecFpWarpUnits.scala 164:81]
  assign resultBanks_6_io_writeResult = held_activeMask[6] ? pipes_6_io_resp_bits_result : 64'h0; // @[AecFpWarpUnits.scala 165:57]
  assign resultBanks_6_io_writeFlags = held_activeMask[6] ? pipes_6_io_resp_bits_exception_flags : 5'h0; // @[AecFpWarpUnits.scala 166:56]
  assign resultBanks_6_io_writePredicate = held_activeMask[6] & pipes_6_io_resp_bits_predicate_result; // @[AecFpWarpUnits.scala 167:92]
  assign resultBanks_6_io_writeError = held_activeMask[6] & pipes_6_io_resp_bits_error; // @[AecFpWarpUnits.scala 168:88]
  assign resultBanks_7_clock = clock;
  assign resultBanks_7_reset = reset;
  assign resultBanks_7_io_write = running & _armCapture_T_5 & allValid & group == 2'h0; // @[AecFpWarpUnits.scala 164:81]
  assign resultBanks_7_io_writeResult = held_activeMask[7] ? pipes_7_io_resp_bits_result : 64'h0; // @[AecFpWarpUnits.scala 165:57]
  assign resultBanks_7_io_writeFlags = held_activeMask[7] ? pipes_7_io_resp_bits_exception_flags : 5'h0; // @[AecFpWarpUnits.scala 166:56]
  assign resultBanks_7_io_writePredicate = held_activeMask[7] & pipes_7_io_resp_bits_predicate_result; // @[AecFpWarpUnits.scala 167:92]
  assign resultBanks_7_io_writeError = held_activeMask[7] & pipes_7_io_resp_bits_error; // @[AecFpWarpUnits.scala 168:88]
  assign resultBanks_8_clock = clock;
  assign resultBanks_8_reset = reset;
  assign resultBanks_8_io_write = running & _armCapture_T_5 & allValid & group == 2'h1; // @[AecFpWarpUnits.scala 164:81]
  assign resultBanks_8_io_writeResult = held_activeMask[8] ? pipes_0_io_resp_bits_result : 64'h0; // @[AecFpWarpUnits.scala 165:57]
  assign resultBanks_8_io_writeFlags = held_activeMask[8] ? pipes_0_io_resp_bits_exception_flags : 5'h0; // @[AecFpWarpUnits.scala 166:56]
  assign resultBanks_8_io_writePredicate = held_activeMask[8] & pipes_0_io_resp_bits_predicate_result; // @[AecFpWarpUnits.scala 167:92]
  assign resultBanks_8_io_writeError = held_activeMask[8] & pipes_0_io_resp_bits_error; // @[AecFpWarpUnits.scala 168:88]
  assign resultBanks_9_clock = clock;
  assign resultBanks_9_reset = reset;
  assign resultBanks_9_io_write = running & _armCapture_T_5 & allValid & group == 2'h1; // @[AecFpWarpUnits.scala 164:81]
  assign resultBanks_9_io_writeResult = held_activeMask[9] ? pipes_1_io_resp_bits_result : 64'h0; // @[AecFpWarpUnits.scala 165:57]
  assign resultBanks_9_io_writeFlags = held_activeMask[9] ? pipes_1_io_resp_bits_exception_flags : 5'h0; // @[AecFpWarpUnits.scala 166:56]
  assign resultBanks_9_io_writePredicate = held_activeMask[9] & pipes_1_io_resp_bits_predicate_result; // @[AecFpWarpUnits.scala 167:92]
  assign resultBanks_9_io_writeError = held_activeMask[9] & pipes_1_io_resp_bits_error; // @[AecFpWarpUnits.scala 168:88]
  assign resultBanks_10_clock = clock;
  assign resultBanks_10_reset = reset;
  assign resultBanks_10_io_write = running & _armCapture_T_5 & allValid & group == 2'h1; // @[AecFpWarpUnits.scala 164:81]
  assign resultBanks_10_io_writeResult = held_activeMask[10] ? pipes_2_io_resp_bits_result : 64'h0; // @[AecFpWarpUnits.scala 165:57]
  assign resultBanks_10_io_writeFlags = held_activeMask[10] ? pipes_2_io_resp_bits_exception_flags : 5'h0; // @[AecFpWarpUnits.scala 166:56]
  assign resultBanks_10_io_writePredicate = held_activeMask[10] & pipes_2_io_resp_bits_predicate_result; // @[AecFpWarpUnits.scala 167:92]
  assign resultBanks_10_io_writeError = held_activeMask[10] & pipes_2_io_resp_bits_error; // @[AecFpWarpUnits.scala 168:88]
  assign resultBanks_11_clock = clock;
  assign resultBanks_11_reset = reset;
  assign resultBanks_11_io_write = running & _armCapture_T_5 & allValid & group == 2'h1; // @[AecFpWarpUnits.scala 164:81]
  assign resultBanks_11_io_writeResult = held_activeMask[11] ? pipes_3_io_resp_bits_result : 64'h0; // @[AecFpWarpUnits.scala 165:57]
  assign resultBanks_11_io_writeFlags = held_activeMask[11] ? pipes_3_io_resp_bits_exception_flags : 5'h0; // @[AecFpWarpUnits.scala 166:56]
  assign resultBanks_11_io_writePredicate = held_activeMask[11] & pipes_3_io_resp_bits_predicate_result; // @[AecFpWarpUnits.scala 167:92]
  assign resultBanks_11_io_writeError = held_activeMask[11] & pipes_3_io_resp_bits_error; // @[AecFpWarpUnits.scala 168:88]
  assign resultBanks_12_clock = clock;
  assign resultBanks_12_reset = reset;
  assign resultBanks_12_io_write = running & _armCapture_T_5 & allValid & group == 2'h1; // @[AecFpWarpUnits.scala 164:81]
  assign resultBanks_12_io_writeResult = held_activeMask[12] ? pipes_4_io_resp_bits_result : 64'h0; // @[AecFpWarpUnits.scala 165:57]
  assign resultBanks_12_io_writeFlags = held_activeMask[12] ? pipes_4_io_resp_bits_exception_flags : 5'h0; // @[AecFpWarpUnits.scala 166:56]
  assign resultBanks_12_io_writePredicate = held_activeMask[12] & pipes_4_io_resp_bits_predicate_result; // @[AecFpWarpUnits.scala 167:92]
  assign resultBanks_12_io_writeError = held_activeMask[12] & pipes_4_io_resp_bits_error; // @[AecFpWarpUnits.scala 168:88]
  assign resultBanks_13_clock = clock;
  assign resultBanks_13_reset = reset;
  assign resultBanks_13_io_write = running & _armCapture_T_5 & allValid & group == 2'h1; // @[AecFpWarpUnits.scala 164:81]
  assign resultBanks_13_io_writeResult = held_activeMask[13] ? pipes_5_io_resp_bits_result : 64'h0; // @[AecFpWarpUnits.scala 165:57]
  assign resultBanks_13_io_writeFlags = held_activeMask[13] ? pipes_5_io_resp_bits_exception_flags : 5'h0; // @[AecFpWarpUnits.scala 166:56]
  assign resultBanks_13_io_writePredicate = held_activeMask[13] & pipes_5_io_resp_bits_predicate_result; // @[AecFpWarpUnits.scala 167:92]
  assign resultBanks_13_io_writeError = held_activeMask[13] & pipes_5_io_resp_bits_error; // @[AecFpWarpUnits.scala 168:88]
  assign resultBanks_14_clock = clock;
  assign resultBanks_14_reset = reset;
  assign resultBanks_14_io_write = running & _armCapture_T_5 & allValid & group == 2'h1; // @[AecFpWarpUnits.scala 164:81]
  assign resultBanks_14_io_writeResult = held_activeMask[14] ? pipes_6_io_resp_bits_result : 64'h0; // @[AecFpWarpUnits.scala 165:57]
  assign resultBanks_14_io_writeFlags = held_activeMask[14] ? pipes_6_io_resp_bits_exception_flags : 5'h0; // @[AecFpWarpUnits.scala 166:56]
  assign resultBanks_14_io_writePredicate = held_activeMask[14] & pipes_6_io_resp_bits_predicate_result; // @[AecFpWarpUnits.scala 167:92]
  assign resultBanks_14_io_writeError = held_activeMask[14] & pipes_6_io_resp_bits_error; // @[AecFpWarpUnits.scala 168:88]
  assign resultBanks_15_clock = clock;
  assign resultBanks_15_reset = reset;
  assign resultBanks_15_io_write = running & _armCapture_T_5 & allValid & group == 2'h1; // @[AecFpWarpUnits.scala 164:81]
  assign resultBanks_15_io_writeResult = held_activeMask[15] ? pipes_7_io_resp_bits_result : 64'h0; // @[AecFpWarpUnits.scala 165:57]
  assign resultBanks_15_io_writeFlags = held_activeMask[15] ? pipes_7_io_resp_bits_exception_flags : 5'h0; // @[AecFpWarpUnits.scala 166:56]
  assign resultBanks_15_io_writePredicate = held_activeMask[15] & pipes_7_io_resp_bits_predicate_result; // @[AecFpWarpUnits.scala 167:92]
  assign resultBanks_15_io_writeError = held_activeMask[15] & pipes_7_io_resp_bits_error; // @[AecFpWarpUnits.scala 168:88]
  assign resultBanks_16_clock = clock;
  assign resultBanks_16_reset = reset;
  assign resultBanks_16_io_write = running & _armCapture_T_5 & allValid & group == 2'h2; // @[AecFpWarpUnits.scala 164:81]
  assign resultBanks_16_io_writeResult = held_activeMask[16] ? pipes_0_io_resp_bits_result : 64'h0; // @[AecFpWarpUnits.scala 165:57]
  assign resultBanks_16_io_writeFlags = held_activeMask[16] ? pipes_0_io_resp_bits_exception_flags : 5'h0; // @[AecFpWarpUnits.scala 166:56]
  assign resultBanks_16_io_writePredicate = held_activeMask[16] & pipes_0_io_resp_bits_predicate_result; // @[AecFpWarpUnits.scala 167:92]
  assign resultBanks_16_io_writeError = held_activeMask[16] & pipes_0_io_resp_bits_error; // @[AecFpWarpUnits.scala 168:88]
  assign resultBanks_17_clock = clock;
  assign resultBanks_17_reset = reset;
  assign resultBanks_17_io_write = running & _armCapture_T_5 & allValid & group == 2'h2; // @[AecFpWarpUnits.scala 164:81]
  assign resultBanks_17_io_writeResult = held_activeMask[17] ? pipes_1_io_resp_bits_result : 64'h0; // @[AecFpWarpUnits.scala 165:57]
  assign resultBanks_17_io_writeFlags = held_activeMask[17] ? pipes_1_io_resp_bits_exception_flags : 5'h0; // @[AecFpWarpUnits.scala 166:56]
  assign resultBanks_17_io_writePredicate = held_activeMask[17] & pipes_1_io_resp_bits_predicate_result; // @[AecFpWarpUnits.scala 167:92]
  assign resultBanks_17_io_writeError = held_activeMask[17] & pipes_1_io_resp_bits_error; // @[AecFpWarpUnits.scala 168:88]
  assign resultBanks_18_clock = clock;
  assign resultBanks_18_reset = reset;
  assign resultBanks_18_io_write = running & _armCapture_T_5 & allValid & group == 2'h2; // @[AecFpWarpUnits.scala 164:81]
  assign resultBanks_18_io_writeResult = held_activeMask[18] ? pipes_2_io_resp_bits_result : 64'h0; // @[AecFpWarpUnits.scala 165:57]
  assign resultBanks_18_io_writeFlags = held_activeMask[18] ? pipes_2_io_resp_bits_exception_flags : 5'h0; // @[AecFpWarpUnits.scala 166:56]
  assign resultBanks_18_io_writePredicate = held_activeMask[18] & pipes_2_io_resp_bits_predicate_result; // @[AecFpWarpUnits.scala 167:92]
  assign resultBanks_18_io_writeError = held_activeMask[18] & pipes_2_io_resp_bits_error; // @[AecFpWarpUnits.scala 168:88]
  assign resultBanks_19_clock = clock;
  assign resultBanks_19_reset = reset;
  assign resultBanks_19_io_write = running & _armCapture_T_5 & allValid & group == 2'h2; // @[AecFpWarpUnits.scala 164:81]
  assign resultBanks_19_io_writeResult = held_activeMask[19] ? pipes_3_io_resp_bits_result : 64'h0; // @[AecFpWarpUnits.scala 165:57]
  assign resultBanks_19_io_writeFlags = held_activeMask[19] ? pipes_3_io_resp_bits_exception_flags : 5'h0; // @[AecFpWarpUnits.scala 166:56]
  assign resultBanks_19_io_writePredicate = held_activeMask[19] & pipes_3_io_resp_bits_predicate_result; // @[AecFpWarpUnits.scala 167:92]
  assign resultBanks_19_io_writeError = held_activeMask[19] & pipes_3_io_resp_bits_error; // @[AecFpWarpUnits.scala 168:88]
  assign resultBanks_20_clock = clock;
  assign resultBanks_20_reset = reset;
  assign resultBanks_20_io_write = running & _armCapture_T_5 & allValid & group == 2'h2; // @[AecFpWarpUnits.scala 164:81]
  assign resultBanks_20_io_writeResult = held_activeMask[20] ? pipes_4_io_resp_bits_result : 64'h0; // @[AecFpWarpUnits.scala 165:57]
  assign resultBanks_20_io_writeFlags = held_activeMask[20] ? pipes_4_io_resp_bits_exception_flags : 5'h0; // @[AecFpWarpUnits.scala 166:56]
  assign resultBanks_20_io_writePredicate = held_activeMask[20] & pipes_4_io_resp_bits_predicate_result; // @[AecFpWarpUnits.scala 167:92]
  assign resultBanks_20_io_writeError = held_activeMask[20] & pipes_4_io_resp_bits_error; // @[AecFpWarpUnits.scala 168:88]
  assign resultBanks_21_clock = clock;
  assign resultBanks_21_reset = reset;
  assign resultBanks_21_io_write = running & _armCapture_T_5 & allValid & group == 2'h2; // @[AecFpWarpUnits.scala 164:81]
  assign resultBanks_21_io_writeResult = held_activeMask[21] ? pipes_5_io_resp_bits_result : 64'h0; // @[AecFpWarpUnits.scala 165:57]
  assign resultBanks_21_io_writeFlags = held_activeMask[21] ? pipes_5_io_resp_bits_exception_flags : 5'h0; // @[AecFpWarpUnits.scala 166:56]
  assign resultBanks_21_io_writePredicate = held_activeMask[21] & pipes_5_io_resp_bits_predicate_result; // @[AecFpWarpUnits.scala 167:92]
  assign resultBanks_21_io_writeError = held_activeMask[21] & pipes_5_io_resp_bits_error; // @[AecFpWarpUnits.scala 168:88]
  assign resultBanks_22_clock = clock;
  assign resultBanks_22_reset = reset;
  assign resultBanks_22_io_write = running & _armCapture_T_5 & allValid & group == 2'h2; // @[AecFpWarpUnits.scala 164:81]
  assign resultBanks_22_io_writeResult = held_activeMask[22] ? pipes_6_io_resp_bits_result : 64'h0; // @[AecFpWarpUnits.scala 165:57]
  assign resultBanks_22_io_writeFlags = held_activeMask[22] ? pipes_6_io_resp_bits_exception_flags : 5'h0; // @[AecFpWarpUnits.scala 166:56]
  assign resultBanks_22_io_writePredicate = held_activeMask[22] & pipes_6_io_resp_bits_predicate_result; // @[AecFpWarpUnits.scala 167:92]
  assign resultBanks_22_io_writeError = held_activeMask[22] & pipes_6_io_resp_bits_error; // @[AecFpWarpUnits.scala 168:88]
  assign resultBanks_23_clock = clock;
  assign resultBanks_23_reset = reset;
  assign resultBanks_23_io_write = running & _armCapture_T_5 & allValid & group == 2'h2; // @[AecFpWarpUnits.scala 164:81]
  assign resultBanks_23_io_writeResult = held_activeMask[23] ? pipes_7_io_resp_bits_result : 64'h0; // @[AecFpWarpUnits.scala 165:57]
  assign resultBanks_23_io_writeFlags = held_activeMask[23] ? pipes_7_io_resp_bits_exception_flags : 5'h0; // @[AecFpWarpUnits.scala 166:56]
  assign resultBanks_23_io_writePredicate = held_activeMask[23] & pipes_7_io_resp_bits_predicate_result; // @[AecFpWarpUnits.scala 167:92]
  assign resultBanks_23_io_writeError = held_activeMask[23] & pipes_7_io_resp_bits_error; // @[AecFpWarpUnits.scala 168:88]
  assign resultBanks_24_clock = clock;
  assign resultBanks_24_reset = reset;
  assign resultBanks_24_io_write = running & _armCapture_T_5 & allValid & group == 2'h3; // @[AecFpWarpUnits.scala 164:81]
  assign resultBanks_24_io_writeResult = held_activeMask[24] ? pipes_0_io_resp_bits_result : 64'h0; // @[AecFpWarpUnits.scala 165:57]
  assign resultBanks_24_io_writeFlags = held_activeMask[24] ? pipes_0_io_resp_bits_exception_flags : 5'h0; // @[AecFpWarpUnits.scala 166:56]
  assign resultBanks_24_io_writePredicate = held_activeMask[24] & pipes_0_io_resp_bits_predicate_result; // @[AecFpWarpUnits.scala 167:92]
  assign resultBanks_24_io_writeError = held_activeMask[24] & pipes_0_io_resp_bits_error; // @[AecFpWarpUnits.scala 168:88]
  assign resultBanks_25_clock = clock;
  assign resultBanks_25_reset = reset;
  assign resultBanks_25_io_write = running & _armCapture_T_5 & allValid & group == 2'h3; // @[AecFpWarpUnits.scala 164:81]
  assign resultBanks_25_io_writeResult = held_activeMask[25] ? pipes_1_io_resp_bits_result : 64'h0; // @[AecFpWarpUnits.scala 165:57]
  assign resultBanks_25_io_writeFlags = held_activeMask[25] ? pipes_1_io_resp_bits_exception_flags : 5'h0; // @[AecFpWarpUnits.scala 166:56]
  assign resultBanks_25_io_writePredicate = held_activeMask[25] & pipes_1_io_resp_bits_predicate_result; // @[AecFpWarpUnits.scala 167:92]
  assign resultBanks_25_io_writeError = held_activeMask[25] & pipes_1_io_resp_bits_error; // @[AecFpWarpUnits.scala 168:88]
  assign resultBanks_26_clock = clock;
  assign resultBanks_26_reset = reset;
  assign resultBanks_26_io_write = running & _armCapture_T_5 & allValid & group == 2'h3; // @[AecFpWarpUnits.scala 164:81]
  assign resultBanks_26_io_writeResult = held_activeMask[26] ? pipes_2_io_resp_bits_result : 64'h0; // @[AecFpWarpUnits.scala 165:57]
  assign resultBanks_26_io_writeFlags = held_activeMask[26] ? pipes_2_io_resp_bits_exception_flags : 5'h0; // @[AecFpWarpUnits.scala 166:56]
  assign resultBanks_26_io_writePredicate = held_activeMask[26] & pipes_2_io_resp_bits_predicate_result; // @[AecFpWarpUnits.scala 167:92]
  assign resultBanks_26_io_writeError = held_activeMask[26] & pipes_2_io_resp_bits_error; // @[AecFpWarpUnits.scala 168:88]
  assign resultBanks_27_clock = clock;
  assign resultBanks_27_reset = reset;
  assign resultBanks_27_io_write = running & _armCapture_T_5 & allValid & group == 2'h3; // @[AecFpWarpUnits.scala 164:81]
  assign resultBanks_27_io_writeResult = held_activeMask[27] ? pipes_3_io_resp_bits_result : 64'h0; // @[AecFpWarpUnits.scala 165:57]
  assign resultBanks_27_io_writeFlags = held_activeMask[27] ? pipes_3_io_resp_bits_exception_flags : 5'h0; // @[AecFpWarpUnits.scala 166:56]
  assign resultBanks_27_io_writePredicate = held_activeMask[27] & pipes_3_io_resp_bits_predicate_result; // @[AecFpWarpUnits.scala 167:92]
  assign resultBanks_27_io_writeError = held_activeMask[27] & pipes_3_io_resp_bits_error; // @[AecFpWarpUnits.scala 168:88]
  assign resultBanks_28_clock = clock;
  assign resultBanks_28_reset = reset;
  assign resultBanks_28_io_write = running & _armCapture_T_5 & allValid & group == 2'h3; // @[AecFpWarpUnits.scala 164:81]
  assign resultBanks_28_io_writeResult = held_activeMask[28] ? pipes_4_io_resp_bits_result : 64'h0; // @[AecFpWarpUnits.scala 165:57]
  assign resultBanks_28_io_writeFlags = held_activeMask[28] ? pipes_4_io_resp_bits_exception_flags : 5'h0; // @[AecFpWarpUnits.scala 166:56]
  assign resultBanks_28_io_writePredicate = held_activeMask[28] & pipes_4_io_resp_bits_predicate_result; // @[AecFpWarpUnits.scala 167:92]
  assign resultBanks_28_io_writeError = held_activeMask[28] & pipes_4_io_resp_bits_error; // @[AecFpWarpUnits.scala 168:88]
  assign resultBanks_29_clock = clock;
  assign resultBanks_29_reset = reset;
  assign resultBanks_29_io_write = running & _armCapture_T_5 & allValid & group == 2'h3; // @[AecFpWarpUnits.scala 164:81]
  assign resultBanks_29_io_writeResult = held_activeMask[29] ? pipes_5_io_resp_bits_result : 64'h0; // @[AecFpWarpUnits.scala 165:57]
  assign resultBanks_29_io_writeFlags = held_activeMask[29] ? pipes_5_io_resp_bits_exception_flags : 5'h0; // @[AecFpWarpUnits.scala 166:56]
  assign resultBanks_29_io_writePredicate = held_activeMask[29] & pipes_5_io_resp_bits_predicate_result; // @[AecFpWarpUnits.scala 167:92]
  assign resultBanks_29_io_writeError = held_activeMask[29] & pipes_5_io_resp_bits_error; // @[AecFpWarpUnits.scala 168:88]
  assign resultBanks_30_clock = clock;
  assign resultBanks_30_reset = reset;
  assign resultBanks_30_io_write = running & _armCapture_T_5 & allValid & group == 2'h3; // @[AecFpWarpUnits.scala 164:81]
  assign resultBanks_30_io_writeResult = held_activeMask[30] ? pipes_6_io_resp_bits_result : 64'h0; // @[AecFpWarpUnits.scala 165:57]
  assign resultBanks_30_io_writeFlags = held_activeMask[30] ? pipes_6_io_resp_bits_exception_flags : 5'h0; // @[AecFpWarpUnits.scala 166:56]
  assign resultBanks_30_io_writePredicate = held_activeMask[30] & pipes_6_io_resp_bits_predicate_result; // @[AecFpWarpUnits.scala 167:92]
  assign resultBanks_30_io_writeError = held_activeMask[30] & pipes_6_io_resp_bits_error; // @[AecFpWarpUnits.scala 168:88]
  assign resultBanks_31_clock = clock;
  assign resultBanks_31_reset = reset;
  assign resultBanks_31_io_write = running & _armCapture_T_5 & allValid & group == 2'h3; // @[AecFpWarpUnits.scala 164:81]
  assign resultBanks_31_io_writeResult = held_activeMask[31] ? pipes_7_io_resp_bits_result : 64'h0; // @[AecFpWarpUnits.scala 165:57]
  assign resultBanks_31_io_writeFlags = held_activeMask[31] ? pipes_7_io_resp_bits_exception_flags : 5'h0; // @[AecFpWarpUnits.scala 166:56]
  assign resultBanks_31_io_writePredicate = held_activeMask[31] & pipes_7_io_resp_bits_predicate_result; // @[AecFpWarpUnits.scala 167:92]
  assign resultBanks_31_io_writeError = held_activeMask[31] & pipes_7_io_resp_bits_error; // @[AecFpWarpUnits.scala 168:88]
  always @(posedge clock) begin
    if (reset) begin // @[AecFpWarpUnits.scala 123:31]
      capturePending <= 1'h0; // @[AecFpWarpUnits.scala 123:31]
    end else if (_requestBuffer_io_capture_T) begin // @[AecFpWarpUnits.scala 174:22]
      capturePending <= 1'h0; // @[AecFpWarpUnits.scala 175:20]
    end else begin
      capturePending <= _GEN_0;
    end
    if (reset) begin // @[AecFpWarpUnits.scala 124:22]
      group <= 2'h0; // @[AecFpWarpUnits.scala 124:22]
    end else if (commitPending) begin // @[AecFpWarpUnits.scala 185:24]
      if (_resultBanks_24_io_write_T_3) begin // @[AecFpWarpUnits.scala 188:37]
        group <= 2'h0; // @[AecFpWarpUnits.scala 188:85]
      end else begin
        group <= _group_T_1; // @[AecFpWarpUnits.scala 188:112]
      end
    end else if (_requestBuffer_io_capture_T) begin // @[AecFpWarpUnits.scala 174:22]
      group <= 2'h0; // @[AecFpWarpUnits.scala 175:38]
    end
    if (reset) begin // @[AecFpWarpUnits.scala 124:91]
      outValid <= 1'h0; // @[AecFpWarpUnits.scala 124:91]
    end else if (_T_11) begin // @[AecFpWarpUnits.scala 190:23]
      outValid <= 1'h0; // @[AecFpWarpUnits.scala 191:14]
    end else if (commitPending) begin // @[AecFpWarpUnits.scala 185:24]
      outValid <= _GEN_9;
    end else if (_requestBuffer_io_capture_T) begin // @[AecFpWarpUnits.scala 174:22]
      outValid <= 1'h0; // @[AecFpWarpUnits.scala 179:14]
    end
    if (reset) begin // @[AecFpWarpUnits.scala 125:24]
      running <= 1'h0; // @[AecFpWarpUnits.scala 125:24]
    end else if (commitPending) begin // @[AecFpWarpUnits.scala 185:24]
      if (_resultBanks_24_io_write_T_3) begin // @[AecFpWarpUnits.scala 188:37]
        running <= 1'h0; // @[AecFpWarpUnits.scala 188:67]
      end else begin
        running <= _GEN_5;
      end
    end else begin
    ...
    if (reset) begin // @[AecFpWarpUnits.scala 126:28]
      groupIssued <= 1'h0; // @[AecFpWarpUnits.scala 126:28]
    end else if (commitPending) begin // @[AecFpWarpUnits.scala 185:24]
      groupIssued <= 1'h0; // @[AecFpWarpUnits.scala 186:17]
    end else begin
      groupIssued <= _GEN_7;
    end
    if (reset) begin // @[AecFpWarpUnits.scala 127:30]
      commitPending <= 1'h0; // @[AecFpWarpUnits.scala 127:30]
    end else if (commitPending) begin // @[AecFpWarpUnits.scala 185:24]
      commitPending <= 1'h0; // @[AecFpWarpUnits.scala 187:19]
    end else begin
      commitPending <= _GEN_8;
    end
    if (reset) begin // @[AecFpWarpUnits.scala 130:27]
      armPending <= 1'h0; // @[AecFpWarpUnits.scala 130:27]
    end else begin
      armPending <= armCapture; // @[AecFpWarpUnits.scala 171:16]
    end
    if (reset) begin // @[AecFpWarpUnits.scala 134:30]
      armClusters_0 <= 1'h0; // @[AecFpWarpUnits.scala 134:30]
    end else begin
      armClusters_0 <= armCapture; // @[AecFpWarpUnits.scala 135:27]
    end
    if (reset) begin // @[AecFpWarpUnits.scala 134:30]
      armClusters_1 <= 1'h0; // @[AecFpWarpUnits.scala 134:30]
    end else begin
      armClusters_1 <= armCapture; // @[AecFpWarpUnits.scala 135:27]
    end
    if (reset) begin // @[AecFpWarpUnits.scala 134:30]
      armClusters_2 <= 1'h0; // @[AecFpWarpUnits.scala 134:30]
    end else begin
      armClusters_2 <= armCapture; // @[AecFpWarpUnits.scala 135:27]
    end
    if (reset) begin // @[AecFpWarpUnits.scala 134:30]
      armClusters_3 <= 1'h0; // @[AecFpWarpUnits.scala 134:30]
    end else begin
      armClusters_3 <= armCapture; // @[AecFpWarpUnits.scala 135:27]
    end
    if (reset) begin // @[AecFpWarpUnits.scala 134:30]
      armClusters_4 <= 1'h0; // @[AecFpWarpUnits.scala 134:30]
    end else begin
      armClusters_4 <= armCapture; // @[AecFpWarpUnits.scala 135:27]
    end
    if (reset) begin // @[AecFpWarpUnits.scala 134:30]
      armClusters_5 <= 1'h0; // @[AecFpWarpUnits.scala 134:30]
    end else begin
      armClusters_5 <= armCapture; // @[AecFpWarpUnits.scala 135:27]
    end
    if (reset) begin // @[AecFpWarpUnits.scala 134:30]
      armClusters_6 <= 1'h0; // @[AecFpWarpUnits.scala 134:30]
    end else begin
      armClusters_6 <= armCapture; // @[AecFpWarpUnits.scala 135:27]
    end
    if (reset) begin // @[AecFpWarpUnits.scala 134:30]
      armClusters_7 <= 1'h0; // @[AecFpWarpUnits.scala 134:30]
    end else begin
      armClusters_7 <= armCapture; // @[AecFpWarpUnits.scala 135:27]
    end
  end
// Register and memory initialization
`ifdef RANDOMIZE_GARBAGE_ASSIGN
